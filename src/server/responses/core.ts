...
import { runResponsesRequestWithGuardrails } from "./guardrails-boundary";
...
export async function handleResponses(
  ...
  return runResponsesRequestWithGuardrails({
    req,
    config,
    logCtx,
    options,
    translatorBudget,
    ownsBudget,
    inner: innerOptions => handleResponsesInner(req, config, logCtx, innerOptions),
  });
}
