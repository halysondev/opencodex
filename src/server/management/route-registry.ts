...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  { method: "GET", path: "/api/zcode-accounts", module: "server/management/zcode-account-routes", mutates: false, mechanism: "path-constant", exempt: { reason: "session-only", why: "Saved-account metadata and OAuth operations require an authenticated dashboard session and explicit browser consent." } },
  { method: "GET", path: "/api/zcode-accounts/login", module: "server/management/zcode-account-routes", mutates: false, mechanism: "path-constant", exempt: { reason: "session-only", why: "OAuth job polling exposes browser-login state only to the authenticated dashboard session that initiated it." } },
  { method: "POST", path: "/api/zcode-accounts/login", module: "server/management/zcode-account-routes", mutates: true, mechanism: "path-constant", exempt: { reason: "session-only", why: "Starting official ZCode OAuth spends the user's identity and requires authenticated dashboard consent." } },
  { method: "POST", path: "/api/zcode-accounts/cancel", module: "server/management/zcode-account-routes", mutates: true, mechanism: "path-constant", exempt: { reason: "session-only", why: "Cancelling a browser-started OAuth job remains confined to an authenticated dashboard session." } },
  { method: "POST", path: "/api/zcode-accounts/complete", module: "server/management/zcode-account-routes", mutates: true, mechanism: "path-constant", exempt: { reason: "session-only", why: "Completing official ZCode OAuth persists account identity only after authenticated dashboard consent." } },
  { method: "POST", path: "/api/zcode-accounts/activate", module: "server/management/zcode-account-routes", mutates: true, mechanism: "path-constant", exempt: { reason: "session-only", why: "Retrying account provider activation is an explicitly consented authenticated-dashboard operation." } },
  { method: "POST", path: "/api/zcode-accounts/rename", module: "server/management/zcode-account-routes", mutates: true, mechanism: "path-constant", exempt: { reason: "session-only", why: "Renaming saved account metadata is intentionally available only to the authenticated dashboard." } },
  { method: "POST", path: "/api/zcode-accounts/remove", module: "server/management/zcode-account-routes", mutates: true, mechanism: "path-constant", exempt: { reason: "session-only", why: "Deleting saved account state is a destructive action requiring authenticated dashboard consent." } },
  { method: "GET", path: "/api/zcode-desktop", module: "server/management/zcode-desktop-routes", mutates: false, exempt: { reason: "session-only", why: "Desktop status contains local runtime and workspace paths reserved for an authenticated dashboard session." } },
  { method: "GET", path: "/api/zcode-desktop/folders", module: "server/management/zcode-desktop-routes", mutates: false, exempt: { reason: "session-only", why: "Browsing host workspace folders reveals local paths and therefore requires an authenticated dashboard session." } },
  { method: "POST", path: "/api/zcode-desktop/connect", module: "server/management/zcode-desktop-routes", mutates: true, exempt: { reason: "session-only", why: "Connecting Desktop authorizes native host execution and provider activation through explicit dashboard consent." } },
  { method: "POST", path: "/api/zcode-desktop/activate", module: "server/management/zcode-desktop-routes", mutates: true, exempt: { reason: "session-only", why: "Retrying partial Desktop activation remains an explicit authenticated-dashboard consent action." } },
  { method: "POST", path: "/api/zcode-desktop/disconnect", module: "server/management/zcode-desktop-routes", mutates: true, exempt: { reason: "session-only", why: "Disconnecting revokes persisted Desktop execution consent and is restricted to the authenticated dashboard." } },
  { method: "POST", path: "/api/zcode-desktop/test", module: "server/management/zcode-desktop-routes", mutates: true, exempt: { reason: "session-only", why: "The optional live test spends ZCode inference quota and therefore requires an authenticated dashboard action." } },
