...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  // server/management/skill-routes
  { method: "GET", path: "/api/skills", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skills", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill import/creation through local service directly." } },
  { method: "GET", path: "/api/skill-sources", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skill-sources", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill source creation through local service directly." } },
  { method: "GET", path: "/api/skill-marketplace/search", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skill-imports", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill import through local service directly." } },
  { method: "POST", path: "/api/skill-deployments/plan", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives deployment planning through local service directly." } },
  { method: "GET", path: "/api/skill-deployments", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skill-deployments", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill deployment through local service directly." } },
  { method: "POST", path: "/api/skill-sync/plan", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives sync planning through local service directly." } },
  { method: "POST", path: "/api/skill-sync", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill sync through local service directly." } },
  { method: "POST", path: "/api/skill-drift/check", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives drift checks through local service directly." } },
  { method: "GET", path: "/api/skill-drift", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "GET", path: "/api/skill-agents", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skill-agents/detect", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives agent detection through local service directly." } },
  { method: "GET", path: "/api/skill-nodes", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skill-nodes", module: "server/management/skill-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives remote node management through local service directly." } },
  { method: "GET", path: "/api/skill-reviews", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "GET", path: "/api/skill-audit", module: "server/management/skill-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  // skill-routes parameterized endpoints
  { method: "GET", path: "/api/skills/{id}", module: "server/management/skill-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "DELETE", path: "/api/skills/{id}", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill deletion through local service directly." } },
  { method: "GET", path: "/api/skills/{id}/versions", module: "server/management/skill-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "GET", path: "/api/skills/{id}/versions/{version}", module: "server/management/skill-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skills/{id}/scan", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill scanning through local service directly." } },
  { method: "GET", path: "/api/skills/{id}/findings", module: "server/management/skill-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches skill data through local service/db operations; src/cli/skill.ts calls getSkillControlService() directly." } },
  { method: "POST", path: "/api/skills/{id}/review", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives review requests through local service directly." } },
  { method: "POST", path: "/api/skills/{id}/publish", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives skill publishing through local service directly." } },
  { method: "POST", path: "/api/skills/{id}/quarantine", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives quarantine through local service directly." } },
  { method: "POST", path: "/api/skills/{id}/revoke", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives revocation through local service directly." } },
  { method: "POST", path: "/api/skill-deployments/{id}/rollback", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives rollback through local service directly." } },
  { method: "DELETE", path: "/api/skill-deployments/{id}", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives deployment removal through local service directly." } },
  { method: "POST", path: "/api/skill-nodes/{id}/test", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives node test through local service directly." } },
  { method: "DELETE", path: "/api/skill-nodes/{id}", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives node deletion through local service directly." } },
  { method: "POST", path: "/api/skill-reviews/{id}/decision", module: "server/management/skill-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives review decisions through local service directly." } },
  // server/management/security-routes
  { method: "GET", path: "/api/security/overview", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/authorizations", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "POST", path: "/api/security/authorizations", module: "server/management/security-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives authorization creation through local service directly." } },
  { method: "GET", path: "/api/security/scopes", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "POST", path: "/api/security/scopes", module: "server/management/security-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives scope creation through local service directly." } },
  { method: "GET", path: "/api/security/campaigns", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "POST", path: "/api/security/campaigns", module: "server/management/security-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives campaign creation through local service directly." } },
  { method: "GET", path: "/api/security/approvals", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/findings", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/skills", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "POST", path: "/api/security/skills/import", module: "server/management/security-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives package import through local service directly." } },
  { method: "GET", path: "/api/security/tools", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/mcp", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/policies", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "POST", path: "/api/security/policies/evaluate", module: "server/management/security-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives policy evaluation through local service directly." } },
  { method: "GET", path: "/api/security/audit", module: "server/management/security-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/authorizations/{id}", module: "server/management/security-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "PATCH", path: "/api/security/authorizations/{id}", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives authorization updates through local service directly." } },
  { method: "POST", path: "/api/security/authorizations/{id}/verify", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives authorization verification through local service directly." } },
  { method: "GET", path: "/api/security/scopes/{id}", module: "server/management/security-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "PATCH", path: "/api/security/scopes/{id}", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives scope updates through local service directly." } },
  { method: "POST", path: "/api/security/scopes/{id}/verify", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives scope verification through local service directly." } },
  { method: "GET", path: "/api/security/campaigns/{id}", module: "server/management/security-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "POST", path: "/api/security/campaigns/{id}/start", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives campaign start through local service directly." } },
  { method: "POST", path: "/api/security/campaigns/{id}/pause", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives campaign pause through local service directly." } },
  { method: "POST", path: "/api/security/campaigns/{id}/resume", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives campaign resume through local service directly." } },
  { method: "POST", path: "/api/security/campaigns/{id}/cancel", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives campaign cancel through local service directly." } },
  { method: "POST", path: "/api/security/campaigns/{id}/recon", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives fixture recon through local service directly." } },
  { method: "GET", path: "/api/security/campaigns/{id}/leads", module: "server/management/security-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/campaigns/{id}/findings", module: "server/management/security-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/campaigns/{id}/evidence", module: "server/management/security-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "GET", path: "/api/security/campaigns/{id}/audit", module: "server/management/security-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches security data through local service/db operations; src/cli/security.ts calls getSecurityControlService() directly." } },
  { method: "POST", path: "/api/security/approvals/{id}/approve", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives approval grants through local service directly." } },
  { method: "POST", path: "/api/security/approvals/{id}/deny", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives approval denials through local service directly." } },
  { method: "POST", path: "/api/security/findings/{id}/validate", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives finding validation through local service directly." } },
  { method: "POST", path: "/api/security/findings/{id}/report", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives report export through local service directly." } },
  { method: "POST", path: "/api/security/skills/{id}/activate", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives package activation through local service directly." } },
  { method: "POST", path: "/api/security/skills/{id}/quarantine", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives package quarantine through local service directly." } },
  { method: "POST", path: "/api/security/mcp/{id}/test", module: "server/management/security-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives MCP tests through local service directly." } },
  ...
  // server/management/social-routes
  { method: "GET", path: "/api/social/overview", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "GET", path: "/api/social/openpost/instances", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "POST", path: "/api/social/openpost/instances", module: "server/management/social-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives instance registration through local service directly." } },
  { method: "GET", path: "/api/social/accounts", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "GET", path: "/api/social/publications", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "GET", path: "/api/social/approvals", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "GET", path: "/api/social/analytics", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "POST", path: "/api/social/publications", module: "server/management/social-routes", mutates: true, exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication creation through local service directly." } },
  { method: "GET", path: "/api/social/jobs", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "GET", path: "/api/social/audit", module: "server/management/social-routes", mutates: false, exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  // social-routes parameterized endpoints
  { method: "POST", path: "/api/social/openpost/instances/{id}/test", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives instance testing through local service directly." } },
  { method: "POST", path: "/api/social/openpost/instances/{id}/sync", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives account sync through local service directly." } },
  { method: "POST", path: "/api/social/accounts/{id}/refresh-capabilities", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives capability refresh through local service directly." } },
  { method: "GET", path: "/api/social/accounts/{id}", module: "server/management/social-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "POST", path: "/api/social/publications/{id}/generate-renditions", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives rendition generation through local service directly." } },
  { method: "POST", path: "/api/social/publications/{id}/validate", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication validation through local service directly." } },
  { method: "POST", path: "/api/social/publications/{id}/approve", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication approval through local service directly." } },
  { method: "POST", path: "/api/social/publications/{id}/reject", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication rejection through local service directly." } },
  { method: "POST", path: "/api/social/publications/{id}/schedule", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication scheduling through local service directly." } },
  { method: "POST", path: "/api/social/publications/{id}/publish", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication publishing through local service directly." } },
  { method: "POST", path: "/api/social/publications/{id}/cancel", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication cancellation through local service directly." } },
  { method: "POST", path: "/api/social/publications/{id}/reconcile", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication reconciliation through local service directly." } },
  { method: "GET", path: "/api/social/publications/{id}/analytics", module: "server/management/social-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "GET", path: "/api/social/publications/{id}", module: "server/management/social-routes", mutates: false, mechanism: "regex", exempt: { reason: "local-transport", why: "The CLI reaches social data through local service/db operations; src/cli/social.ts calls getSocialPublishingService() directly." } },
  { method: "PATCH", path: "/api/social/publications/{id}", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives publication updates through local service directly." } },
  { method: "POST", path: "/api/social/jobs/{id}/retry", module: "server/management/social-routes", mutates: true, mechanism: "regex", exempt: { reason: "session-only", why: "Interactive dashboard operation; CLI drives job retry through local service directly." } },
