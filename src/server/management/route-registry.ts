...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  { method: "GET", path: "/api/zcode-accounts", module: "server/management/zcode-account-routes", mutates: false },
  { method: "GET", path: "/api/zcode-accounts/login", module: "server/management/zcode-account-routes", mutates: false },
  { method: "POST", path: "/api/zcode-accounts/login", module: "server/management/zcode-account-routes", mutates: true },
  { method: "POST", path: "/api/zcode-accounts/cancel", module: "server/management/zcode-account-routes", mutates: true },
  { method: "POST", path: "/api/zcode-accounts/complete", module: "server/management/zcode-account-routes", mutates: true },
  { method: "POST", path: "/api/zcode-accounts/activate", module: "server/management/zcode-account-routes", mutates: true },
  { method: "POST", path: "/api/zcode-accounts/rename", module: "server/management/zcode-account-routes", mutates: true },
  { method: "POST", path: "/api/zcode-accounts/remove", module: "server/management/zcode-account-routes", mutates: true },
