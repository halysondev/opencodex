...
export const zh: Record<TKey, string> = {
  ...
  "zcodeUsage.offPeak": "非高峰时段：截至 {until}，标准模型积分费率优惠 50%。",
  "zcodeUsage.flashActive": "通过 ZCode 使用 GLM-5.3-Flash 的免费时段已生效：符合以下条件时，截至 {end} 不消耗额度。",
  "zcodeUsage.flashNext": "下一个通过 ZCode 使用 GLM-5.3-Flash 的免费时段：{start} – {end}。",
  "zcodeUsage.eligibility": "需要付费 GLM Coding Plan、ZCode 3.10 或更高版本，且 5 小时和每周额度都必须有剩余。此处未核验余额及资格。GLM-5.3 和其他 Agent 不享受此零额度消耗优惠。",
  "zcodeUsage.rules": "高峰：新加坡时间周一至周五 14:00–18:00，其余均为非高峰。Flash 活动：2026 年 9 月 3–20 日，每天新加坡时间 23:00–次日 09:00。末夜是否延长未明确说明，因此提示保守地于 9 月 20 日结束时停止。不修改用量或费用报告。",
  "zcodeUsage.source": "官方费率 · 2026 年 9 月 11 日核验",
  "zcodeUsage.campaignSource": "官方活动条件",
  "zcodeDesktop.providerPending": "Desktop 协议已验证，但提供商注册尚未完成。请重试启用；现有设置将保留。",
  ...
  "zcodeAccounts.consent": "我授权官方 ZCode 登录并管理这些账户。登录完成后启用该账户的提供商和目录，不更改默认设置，也不发送推理请求。",
  "zcodeAccounts.add": "添加账户",
  "zcodeAccounts.loginHint": "请在浏览器完成官方登录。使用其他账户时，请切换账户或使用隐私窗口。链接会过期，请保持此面板打开。",
  "zcodeAccounts.login": "打开官方登录",
  "zcodeAccounts.failed": "无法完成操作。登录过期请重试，重复账户请重新连接，等待活动任务结束，并在删除前移除路由引用。",
  "zcodeAccounts.pending": "账户设置未完成",
  "zcodeAccounts.reconnect": "重新登录",
  ...
  "zcodeDesktop.open": "打开 ZCode Desktop",
  "zcodeDesktop.detect": "重新检测",
  "zcodeDesktop.download": "下载 ZCode",
  "zcodeDesktop.location": "Desktop 安装目录（高级）",
  "zcodeDesktop.workspace": "工作目录",
  "zcodeDesktop.browse": "浏览目录",
  "zcodeDesktop.up": "上级目录",
  "zcodeDesktop.select": "选择",
  "zcodeDesktop.consent": "我允许 OpenCodex 在此工作区运行官方 ZCode、读取 Desktop 配置、启用提供商并更新 Codex 目录。以后发送请求时，ZCode 可能执行原生工具。",
  "zcodeDesktop.back": "返回",
  "zcodeDesktop.connect": "连接 Desktop",
  "zcodeDesktop.disconnect": "断开连接",
  "zcodeDesktop.testHint": "可选：重新验证官方 ZCode 协议和所选模型，不会启动模型轮次、运行原生工具或消耗配额。",
  "zcodeDesktop.model": "模型",
  "zcodeDesktop.test": "重新验证协议",
  "zcodeDesktop.testPassed": "ZCode 协议验证成功。",
  ...
  "zcodeDesktop.protocolFailed": "ZCode 协议验证未完成。请在 Desktop 中检查登录状态及模型权限后重新连接。未启动模型轮次、原生工具或直接 API 回退。",
  "zcodeDesktop.failed": "无法连接官方运行时。请检查 Desktop、所选目录和隔离依赖后重试。",
