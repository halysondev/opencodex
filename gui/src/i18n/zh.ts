...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.copilotContextTier": "GitHub Copilot 上下文层级",
  "pws.copilotContextTierDefault": "默认上下文",
  "pws.copilotContextTierLong": "长上下文（支持时）",
  "pws.copilotContextTierDesc": "为每个检测到或已配置的 Copilot 模型选择上下文层级。OpenCodex 会在支持时传递所选层级；提供商 cap 仍会限制目录窗口。",
  "pws.copilotContextTierNoModels": "尚未检测到 Copilot 模型。请刷新模型，或在“模型”标签页中配置一个模型。",
