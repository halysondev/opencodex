...
export const zh: Record<TKey, string> = {
  ...
  "zcodeDesktop.intro": "连接此计算机上 ZCode Desktop 中配置的 Z.AI 模型，无需粘贴 API 密钥。OpenCodex 启动官方运行时，不接管现有 Desktop 对话。",
  "zcodeDesktop.connected": "Desktop 已连接 · 本地协议已验证",
  ...
  "zcodeDesktop.consent": "我允许 ZCode 在此目录中修改文件并执行命令。Desktop 配置保持只读。命令可以访问网络。请仅连接可信的官方 ZCode 安装。",
  "zcodeDesktop.back": "返回",
  "zcodeDesktop.connect": "连接 Desktop",
  "zcodeDesktop.disconnect": "断开连接",
  "zcodeDesktop.use": "使用此提供商",
