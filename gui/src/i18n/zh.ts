...
export const zh: Record<TKey, string> = {
  ...
  "zcodeDesktop.testHint": "可选：通过 ZCode 发送一次简短请求以验证模型访问权限。这会消耗账户配额；仅连接不会消耗。",
  ...
  "zcodeDesktop.inferenceFailed": "ZCode 未完成测试。请在 Desktop 中检查登录状态及模型权限后重新连接。未使用直接 API 回退。",
