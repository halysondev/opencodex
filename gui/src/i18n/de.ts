...
export const de: Record<TKey, string> = {
  ...
  "zcodeDesktop.intro": "Verbinden Sie die auf diesem Computer in ZCode Desktop eingerichteten Z.AI-Modelle ohne API-Schlüssel-Eingabe. OpenCodex startet die offizielle Laufzeit, keine vorhandene Desktop-Unterhaltung.",
  "zcodeDesktop.connected": "Desktop verbunden · lokales Protokoll geprüft",
  ...
  "zcodeDesktop.consent": "Ich erlaube ZCode, Dateien in diesem Ordner zu ändern und Befehle auszuführen. Desktop-Einstellungen bleiben schreibgeschützt. Befehle haben Netzwerkzugriff. Nur eine vertrauenswürdige offizielle Installation verbinden.",
  "zcodeDesktop.back": "Zurück",
  "zcodeDesktop.connect": "Desktop verbinden",
  "zcodeDesktop.disconnect": "Trennen",
  "zcodeDesktop.use": "Diesen Anbieter verwenden",
