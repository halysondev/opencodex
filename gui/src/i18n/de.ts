...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "guardrails.title": "Schutz sensibler Daten",
  "guardrails.subtitle": "Erkannte sensible Werte werden durch umkehrbare Platzhalter ersetzt, bevor Anfragen diesen Proxy verlassen.",
  "guardrails.loading": "Guardrails-Einstellungen werden geladen…",
  "guardrails.loadFailed": "Guardrails-Einstellungen konnten nicht geladen werden.",
  "guardrails.saveFailed": "Guardrails-Einstellungen konnten nicht gespeichert werden.",
  "guardrails.saved": "Guardrails-Einstellungen gespeichert.",
  "guardrails.statusActive": "Aktiv",
  "guardrails.statusDisabled": "Deaktiviert",
  "guardrails.settingsTitle": "Anfrageschutz",
  "guardrails.settingsHint": "Änderungen werden atomar auf neue Anfragen angewendet. Bestehende Streams behalten ihre aktuelle Zuordnung.",
  "guardrails.enabled": "Guardrails aktivieren",
  "guardrails.enabledHint": "Zugelassene Prompt- und Tool-Felder maskieren, bevor sie einen Upstream-Anbieter erreichen.",
  "guardrails.mode": "Modus",
  "guardrails.modeEnforce": "Maskierung erzwingen",
  "guardrails.modeDetect": "Nur erkennen",
  "guardrails.failurePolicy": "Verarbeitungsfehler",
  "guardrails.failureBlock": "Anfrage blockieren",
  "guardrails.failurePassthrough": "Anfrage durchlassen",
  "guardrails.keywordPrefilter": "Schlüsselwort-Vorfilter",
  "guardrails.keywordPrefilterHint": "Nur integrierte Regeln überspringen, deren Regex nachweislich in jedem Treffer ein Schlüsselwort enthält. Eigene und nicht beweisbare Regeln werden immer geprüft.",
  "guardrails.dataTypes": "Aktivierte Datentypen",
  "guardrails.dataType": "Datentyp",
  "guardrails.dataType.credentials": "Zugangsdaten",
  "guardrails.groupCredentialUrls": "URLs mit Zugangsdaten",
  "guardrails.dataType.apiKeys": "API-Schlüssel",
  "guardrails.dataType.accessTokens": "Zugriffstoken",
  "guardrails.dataType.ipAddresses": "IP-Adressen",
  "guardrails.dataType.personal": "Personenbezogene Daten",
  "guardrails.dataType.custom": "Benutzerdefiniert",
  "guardrails.rulesTitle": "Regelverwaltung",
  "guardrails.rulesHint": "Deaktivieren Sie eine integrierte Regel oder verwalten Sie lokale benutzerdefinierte Regeln. Integrierte reguläre Ausdrücke werden hier nie offengelegt.",
  "guardrails.selectBuiltin": "Integrierte Regel auswählen",
  "guardrails.disableBuiltin": "Regel deaktivieren",
  "guardrails.enableBuiltin": "Regel aktivieren",
  "guardrails.noDisabledBuiltins": "Keine integrierten Regeln sind deaktiviert.",
  "guardrails.customRules": "Benutzerdefinierte Regeln",
  "guardrails.noCustomRules": "Noch keine benutzerdefinierten Regeln.",
  "guardrails.addRule": "Regel hinzufügen",
  "guardrails.editRule": "Regel bearbeiten",
  "guardrails.deleteRule": "Regel löschen",
  "guardrails.removeRuleConfirm": "Benutzerdefinierte Regel {ruleId} löschen?",
  "guardrails.ruleSaveFailed": "Die benutzerdefinierte Regel konnte nicht gespeichert werden.",
  "guardrails.ruleDeleteFailed": "Die benutzerdefinierte Regel konnte nicht gelöscht werden.",
  "guardrails.ruleSaved": "Benutzerdefinierte Regel gespeichert.",
  "guardrails.ruleDeleted": "Benutzerdefinierte Regel gelöscht.",
  "guardrails.ruleId": "Regel-ID",
  "guardrails.ruleName": "Regelname",
  "guardrails.group": "Gruppe",
  "guardrails.groupPriority": "Gruppenpriorität",
  "guardrails.displayName": "Anzeigename",
  "guardrails.description": "Beschreibung",
  "guardrails.regex": "RE2-Muster",
  "guardrails.placeholderType": "Platzhaltertyp",
  "guardrails.captureGroups": "Erfassungsgruppen",
  "guardrails.captureGroupsInvalid": "Verwenden Sie eine durch Kommas getrennte Liste positiver ganzzahliger Gruppennummern.",
  "guardrails.minLength": "Mindestlänge",
  "guardrails.entropy": "Entropieschwelle",
  "guardrails.keywords": "Schlüsselwörter",
  "guardrails.banlist": "Sperrliste",
  "guardrails.validators": "Validatoren",
  "guardrails.saveRule": "Regel speichern",
  "guardrails.cancelEdit": "Abbrechen",
  "guardrails.tabsLabel": "Guardrails-Bereiche",
  "guardrails.tab.overview": "Übersicht",
  "guardrails.tab.rules": "Regeln",
  "guardrails.tab.tester": "Tester",
  "guardrails.tab.activity": "Aktivität",
  "guardrails.tab.settings": "Einstellungen",
  "guardrails.detectWarning": "Im Nur-erkennen-Modus werden Treffer gemeldet, sensible Daten jedoch nicht maskiert, bevor sie den Proxy verlassen.",
  "guardrails.passthroughWarning": "Beim Durchlassen können unmaskierte Eingaben an den Upstream gesendet werden, wenn die Guardrails-Verarbeitung fehlschlägt.",
  "guardrails.metric.scanned": "Gescannte Anfragen",
  "guardrails.metric.masked": "Maskierte Werte",
  "guardrails.metric.detected": "Erkannte Werte",
  "guardrails.metric.errors": "Warnungen und Blockierungen",
  "guardrails.lastPassthrough": "Letzter Durchlassvorfall: {date}",
  "guardrails.topRules": "Häufigste Regeln",
  "guardrails.topCategories": "Häufigste Datenkategorien",
  "guardrails.noActivity": "Noch keine Guardrails-Aktivität",
  "guardrails.noActivityHint": "Metadaten werden hier angezeigt, nachdem geschützte Anfragen verarbeitet wurden.",
  "guardrails.documentation": "Guardrails-Dokumentation lesen",
  "guardrails.searchRules": "Regeln durchsuchen",
  "guardrails.source": "Quelle",
  "guardrails.sourceOpenCodex": "OpenCodex-Regeln",
  "guardrails.sourceManual": "Integriert",
  "guardrails.allSources": "Alle Quellen",
  "guardrails.status": "Status",
  "guardrails.allStatuses": "Alle Status",
  "guardrails.allDataTypes": "Alle Datentypen",
  "guardrails.filteredRules": "Gefilterte Regeln: {count}",
  ...
  "guardrails.importReplace": "Ersetzen",
  "guardrails.importFailed": "Guardrails-Regeln konnten nicht importiert werden.",
  "guardrails.importTooLarge": "Guardrails-Importdateien dürfen höchstens 4 MiB groß sein.",
  "guardrails.imported": "Guardrails-Regeln importiert.",
  "guardrails.noRules": "Keine Regeln entsprechen diesen Filtern.",
  "guardrails.previous": "Zurück",
  "guardrails.next": "Weiter",
  "guardrails.page": "Seite {current} von {total}",
  "guardrails.testerTitle": "Tester für sensible Daten",
  "guardrails.testerHint": "Mit dem wirksamen Regelregister dieser OpenCodex-Instanz scannen. Der Text wird an deren Management API, niemals an einen LLM-Anbieter, gesendet und serverseitig nicht gespeichert.",
  "guardrails.testerInput": "Zu scannender Text",
  "guardrails.testerPlaceholder": "Beispieltext hier einfügen…",
  "guardrails.byteCounter": "{current} / {max} Byte",
  "guardrails.clear": "Leeren",
  "guardrails.test": "Scannen",
  "guardrails.testing": "Wird gescannt…",
  "guardrails.testerFailed": "Der Text konnte nicht gescannt werden.",
  "guardrails.testerResult": "Scanergebnis",
  "guardrails.effective": "Wirksame Einstellungen",
  "guardrails.draft": "Entwurfseinstellungen",
  "guardrails.findings": "Treffer",
  "guardrails.noFindings": "Die aktivierten Regeln fanden keine Treffer; dies garantiert nicht, dass der Text keine sensiblen Daten enthält.",
  "guardrails.placeholder": "Platzhalter",
  "guardrails.offsets": "Positionen",
  "guardrails.activityTitle": "Guardrails-Aktivität",
  "guardrails.activityPrivacy": "Nur Metadaten im Arbeitsspeicher; dies ist kein Auditprotokoll. Prompttext und Platzhalterzuordnungen werden hier nie gespeichert.",
  "guardrails.surface": "Schnittstelle",
  "guardrails.allSurfaces": "Alle Schnittstellen",
  "guardrails.allModes": "Alle Modi",
  "guardrails.result": "Ergebnis",
  "guardrails.allResults": "Alle Ergebnisse",
  "guardrails.result.scanned": "Gescannt",
  "guardrails.result.masked": "Maskiert",
  "guardrails.result.detected": "Erkannt",
  "guardrails.result.blocked": "Blockiert",
  "guardrails.result.passthrough": "Durchgelassen",
  "guardrails.result.demaskWarning": "Warnung beim Demaskieren",
  "guardrails.result.toolSkipped": "Tool-Wiederherstellung übersprungen",
  "guardrails.refresh": "Aktualisieren",
  "guardrails.retentionEvents": "Gespeicherte Ereignisse: {current} von {max}",
  "guardrails.retentionEvicted": "Entfernte Ereignisse: {count}",
  "guardrails.lastRefresh": "Letzte Aktualisierung: {date}",
  "guardrails.time": "Zeit",
  "guardrails.count": "Anzahl",
  "guardrails.rules": "Regeln",
  "guardrails.latency": "Latenz",
  "guardrails.dialog.disable.title": "Guardrails deaktivieren?",
  "guardrails.dialog.disable.changes": "Neue Anfragen werden nicht mehr gescannt oder maskiert.",
  "guardrails.dialog.disable.breakage": "Sensible Werte können diesen Proxy unverändert verlassen.",
  "guardrails.dialog.disable.undo": "Aktivieren Sie Guardrails unter „Übersicht“ oder „Einstellungen“ erneut.",
  "guardrails.dialog.disable.confirm": "Deaktivieren",
  "guardrails.dialog.detect.title": "In den Nur-erkennen-Modus wechseln?",
  "guardrails.dialog.detect.changes": "Treffer werden gezählt, der Anfragetext wird jedoch nicht maskiert.",
  "guardrails.dialog.detect.breakage": "Der Nur-erkennen-Modus schützt keine an den Upstream gesendeten Daten.",
  "guardrails.dialog.detect.undo": "Wechseln Sie zurück zum Modus „Maskierung erzwingen“.",
  "guardrails.dialog.detect.confirm": "Nur-erkennen-Modus verwenden",
  "guardrails.dialog.passthrough.title": "Durchlassen bei Fehlern erlauben?",
  "guardrails.dialog.passthrough.changes": "Bei einem Guardrails-Verarbeitungsfehler wird die ursprüngliche Anfrage weitergeleitet.",
  "guardrails.dialog.passthrough.breakage": "Die fehlgeschlagene Anfrage kann unmaskierte sensible Werte enthalten.",
  "guardrails.dialog.passthrough.undo": "Setzen Sie die Fehlerbehandlung zurück auf „Anfrage blockieren“.",
  "guardrails.dialog.passthrough.confirm": "Durchlassen erlauben",
  "guardrails.dialog.delete.title": "Benutzerdefinierte Regel {ruleId} löschen?",
  "guardrails.dialog.delete.changes": "Die benutzerdefinierte Regel wird aus dem wirksamen Regelregister entfernt.",
  "guardrails.dialog.delete.breakage": "Werte, die nur von dieser Regel erkannt werden, sind nicht mehr geschützt.",
  "guardrails.dialog.delete.undo": "Importieren oder erstellen Sie die Regel erneut, um sie wiederherzustellen.",
  "guardrails.dialog.delete.confirm": "Regel löschen",
  "guardrails.dialog.import.title": "Alle Guardrails-Regeln ersetzen?",
  "guardrails.dialog.import.changes": "Das importierte Paket ersetzt die aktuellen Guardrails-Einstellungen und benutzerdefinierten Regeln.",
  "guardrails.dialog.import.breakage": "Lokale Regeln, die nicht im Paket enthalten sind, werden entfernt.",
  "guardrails.dialog.import.undo": "Exportieren Sie das aktuelle Paket, bevor Sie es ersetzen.",
  "guardrails.dialog.import.confirm": "Regeln ersetzen",
  "guardrails.sourceGitleaks": "Gitleaks-Regeln",
  "guardrails.surfaceCompact": "Kompakt",
  "guardrails.registryReady": "Regelregister bereit",
  "guardrails.registryFailed": "Regelregister fehlerhaft",
  "guardrails.registryDisabled": "Regelregister deaktiviert",
  "guardrails.effectiveRules": "Wirksame Regeln: {count}",
  "guardrails.registryGeneration": "Generation {generation}",
  "guardrails.testerDraftSettings": "Entwurfseinstellungen verwenden",
  "guardrails.testerDraftSettingsHint": "Eine andere Auswahl von Datentypen und Schlüsselwort-Vorfilter testen, ohne sie zu speichern.",
  "guardrails.showingEvents": "{shown} von {total} passenden Ereignissen werden angezeigt",
  "guardrails.oldestEvent": "Ältestes gespeichertes Ereignis: {date}",
  "guardrails.tableScrollHint": "Scrollen Sie horizontal durch die Tabelle, um alle Spalten zu sehen.",
  "guardrails.importPreviewTitle": "Importvorschau",
  "guardrails.importCreateCount": "Neu: {count}",
  "guardrails.importReplaceCount": "Ersetzen: {count}",
  "guardrails.importUnchangedCount": "Unverändert: {count}",
  "guardrails.importConflicts": "Konflikte bei Regel-IDs: {count}. Beheben Sie sie vor dem Import.",
  "guardrails.importApply": "Import anwenden",
  "guardrails.category": "Kategorie",
  "guardrails.allCategories": "Alle Kategorien",
  "guardrails.generation": "Generation",
  "guardrails.activitySummary": "Zusammenfassung der gefilterten Aktivität",
  "guardrails.activityEvents": "Ereignisse: {count}",
  "guardrails.activityFindings": "Treffer: {count}",
  "guardrails.activityAverageLatency": "Durchschnittliche Latenz: {value} ms",
  "guardrails.activityTopRule": "Häufigste Regel: {rule}",
  "guardrails.recentActivity": "Letzte Aktivität",
  "guardrails.dialog.ruleDisable.title": "Regel {ruleId} deaktivieren?",
  "guardrails.dialog.ruleDisable.changes": "Diese integrierte Regel scannt keine neuen Anfragen mehr.",
  "guardrails.dialog.ruleDisable.breakage": "Werte, die nur von dieser Regel erkannt werden, sind nicht mehr geschützt.",
  "guardrails.dialog.ruleDisable.undo": "Aktivieren Sie die Regel auf der Registerkarte „Regeln“ erneut.",
  "guardrails.dialog.ruleDisable.confirm": "Regel deaktivieren",
  "guardrails.dialog.bulkDisable.title": "{count} Regeln deaktivieren?",
  "guardrails.dialog.bulkDisable.changes": "Alle gefilterten integrierten Regeln in dieser Auswahl werden deaktiviert.",
  "guardrails.dialog.bulkDisable.breakage": "Sensible Werte, die nur von diesen Regeln abgedeckt werden, können den Proxy unverändert verlassen.",
  "guardrails.dialog.bulkDisable.undo": "Aktivieren Sie die Regeln auf der Registerkarte „Regeln“ erneut oder importieren Sie einen früheren Export.",
  "guardrails.dialog.bulkDisable.confirm": "Regeln deaktivieren",
  "guardrails.statusProtected": "Geschützt",
  "guardrails.statusDetectOnly": "Nur Erkennung",
  "guardrails.statusReducedCoverage": "Reduzierte Abdeckung",
  "guardrails.statusUnavailable": "Register nicht verfügbar",
  "guardrails.statusNoRules": "Keine aktiven Regeln",
  "guardrails.statusNoProviderCoverage": "Keine Anbieter geschützt",
  "guardrails.valueOn": "Ein",
  "guardrails.valueOff": "Aus",
  "guardrails.reducedCoverageWarning": "Reduzierte Abdeckung: Datentypen oder integrierte Regeln sind deaktiviert, die Anbieterabdeckung ist begrenzt oder Verarbeitungsfehler werden durchgereicht.",
  "guardrails.providerScope": "Geschützte Anbieter",
  "guardrails.providerScopeAllValue": "Alle Anbieter",
  "guardrails.providerScopeSelectedValue": "Ausgewählt ({count})",
  "guardrails.importSecurityProviderScope": "Anbieterabdeckung: {before} → {after}",
  "guardrails.providerScopeAllHint": "Alle aktuellen und zukünftigen Anbieter sind geschützt.",
  "guardrails.providerScopeSelectedHint": "Nur ausgewählte Anbieter sind geschützt. Neue Anbieter bleiben ungeschützt, bis sie ausgewählt werden.",
  "guardrails.providerAnthropicNative": "Anthropic (nativ)",
  "guardrails.providerDisabled": "deaktiviert",
  "guardrails.providerNotConfigured": "nicht konfiguriert",
  "guardrails.lastProviderRequired": "Mindestens einen Anbieter auswählen oder Guardrails vollständig deaktivieren.",
  "guardrails.providerScopeWarning": "Die Anbieterabdeckung ist eingeschränkt. Anfragen an nicht ausgewählte Anbieter werden weder geprüft noch maskiert.",
  "guardrails.noProviderCoverageWarning": "Kein aktiver Anbieter ist ausgewählt. Der aktuelle Anbieter-Datenverkehr wird weder geprüft noch maskiert.",
  "guardrails.dialog.providerScope.title": "Anbieterabdeckung einschränken?",
  "guardrails.dialog.providerScope.changes": "Neue direkte Anfragen an den abgewählten Anbieter werden nicht mehr geprüft oder maskiert.",
  "guardrails.dialog.providerScope.breakage": "Sensible Werte können diesen Anbieter unverändert erreichen. Geschützte Fortsetzungen überschreiten diese Grenze nicht.",
  "guardrails.dialog.providerScope.undo": "Wählen Sie den Anbieter in den Guardrails-Einstellungen erneut aus, um den Schutz wiederherzustellen.",
  "guardrails.dialog.providerScope.confirm": "Abdeckung einschränken",
  "guardrails.lastDataTypeRequired": "Mindestens ein Datentyp muss aktiviert bleiben.",
  "guardrails.importSecurityTitle": "Sicherheitseinstellungen",
  "guardrails.importSecurityWeakening": "Dieser Import reduziert den Schutz. Prüfen Sie jede hervorgehobene Änderung, bevor Sie fortfahren.",
  "guardrails.importSecurityPotential": "Dieser Import ändert sicherheitsrelevante benutzerdefinierte Regeln und kann den Schutz reduzieren. Prüfen Sie sie vor dem Fortfahren.",
  "guardrails.importSecurityUnchanged": "Die Guardrails-Sicherheitseinstellungen ändern sich nicht.",
  "guardrails.importSecurityEnabled": "Datenverkehrsschutz: {before} → {after}",
  "guardrails.importSecurityMode": "Modus: {before} → {after}",
  "guardrails.importSecurityFailure": "Fehlerbehandlung: {before} → {after}",
  "guardrails.importSecurityDataTypes": "Aktivierte Datentypen: {before} → {after}",
  "guardrails.importSecurityDisabledRules": "Deaktivierte integrierte Regeln: {before} → {after} (neu deaktiviert: {disabled}, reaktiviert: {reenabled})",
  "guardrails.importSecurityCustomRules": "Benutzerdefinierte Regeln: {before} → {after} (entfernt: {removed}, geändert: {changed})",
  "guardrails.importSecurityChangedRuleIds": "Geänderte Regeldefinitionen:",
  "guardrails.importSecurityRemovedRuleIds": "Entfernte Regel-IDs:",
  "guardrails.importSecurityPrefilter": "Schlüsselwort-Vorfilter: {before} → {after}",
  "guardrails.importSecurityReduced": "Reduzierter Schutz",
  "guardrails.importSecurityReviewRequired": "Sicherheitsprüfung erforderlich",
  "guardrails.importSecurityRemovedTypes": "Nicht mehr abgedeckt: {types}",
  "guardrails.testerSimulation": "Nur Tester-Simulation. Verwenden Sie synthetische Werte; fügen Sie niemals echte Geheimnisse ein. Im verbundenen Modus kann der Text Ihren OpenCodex-Hub durchlaufen.",
  "guardrails.testerTrafficDisabled": "Der Schutz des realen Datenverkehrs ist deaktiviert. Anfragen verlassen den Proxy derzeit ohne Guardrails-Maskierung.",
  "guardrails.testerTrafficDetect": "Der reale Datenverkehr wird nur erkannt und vor dem Anbieter nicht maskiert.",
  "guardrails.testerTrafficUnknown": "Der Schutzstatus des realen Datenverkehrs ist noch unbekannt. Warten Sie auf den Guardrails-Status.",
  "guardrails.testerTrafficUnavailable": "Der Schutz des realen Datenverkehrs ist nicht verfügbar. Beheben Sie den Aktivierungs- oder Registry-Fehler.",
  "guardrails.testerTrafficNoRules": "Für den realen Datenverkehr sind keine Guardrails-Regeln aktiv. Aktivieren Sie mindestens eine wirksame Regel.",
  "guardrails.testerTrafficNoProviderCoverage": "Die Simulation kann Treffer finden, aber derzeit ist kein aktiver Anbieter für den Schutz ausgewählt.",
  "guardrails.testerTrafficReduced": "Der reale Datenverkehr ist nur reduziert geschützt. Prüfen Sie deaktivierte Regeln, Datentypen, Anbieterabdeckung und Fehlerpolitik.",
  "guardrails.dialog.categoryDisable.title": "Datenkategorie deaktivieren?",
  "guardrails.dialog.categoryDisable.changes": "Regeln dieser Kategorie prüfen neue Anfragen nicht mehr.",
  "guardrails.dialog.categoryDisable.breakage": "Sensible Werte, die nur diese Kategorie abdeckt, können den Proxy unverändert verlassen.",
  "guardrails.dialog.categoryDisable.undo": "Aktivieren Sie die Kategorie in den Guardrails-Einstellungen erneut.",
  "guardrails.dialog.categoryDisable.confirm": "Kategorie deaktivieren",
  "guardrails.dialog.prefilter.title": "Schlüsselwort-Vorfilter aktivieren?",
  "guardrails.dialog.prefilter.changes": "Regeln mit Schlüsselwörtern können übersprungen werden, wenn diese im zu prüfenden Text fehlen.",
  "guardrails.dialog.prefilter.breakage": "Dieser Leistungskompromiss kann die Erkennungsabdeckung verringern.",
  "guardrails.dialog.prefilter.undo": "Deaktivieren Sie den Schlüsselwort-Vorfilter in den Guardrails-Einstellungen.",
  "guardrails.dialog.prefilter.confirm": "Vorfilter aktivieren",
  "guardrails.dialog.importWeakening.title": "Import anwenden, der den Schutz reduziert?",
  "guardrails.dialog.importWeakening.changes": "Das importierte Paket ersetzt Guardrails-Einstellungen und benutzerdefinierte Regeln durch die angezeigten Werte.",
  "guardrails.dialog.importWeakening.breakage": "Mindestens eine hervorgehobene Einstellung lässt zusätzliche sensible Werte unverändert Anbieter erreichen.",
  "guardrails.dialog.importWeakening.undo": "Exportieren Sie das aktuelle Paket, bevor Sie diesen Import anwenden.",
  "guardrails.dialog.importWeakening.confirm": "Reduzierten Schutz anwenden",};
