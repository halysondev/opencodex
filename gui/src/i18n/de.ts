...
export const de: Record<TKey, string> = {
  ...
  "zcodeDesktop.testHint": "Optional: Eine kurze Anfrage über ZCode prüft den Modellzugriff und verbraucht Kontingent. Die Verbindung allein verbraucht keines.",
  "zcodeDesktop.model": "Modell",
  "zcodeDesktop.test": "Mit einer Anfrage testen",
  "zcodeDesktop.testPassed": "ZCode hat erfolgreich geantwortet.",
  ...
  "zcodeDesktop.inferenceFailed": "Der ZCode-Test ist fehlgeschlagen. Prüfen Sie Anmeldung und Modellzugriff in Desktop. Keine direkte API wurde als Ersatz verwendet.",
