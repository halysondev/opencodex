...
export const de: Record<TKey, string> = {
  ...
  "zcodeUsage.offPeak": "Nebenzeit: 50 % Rabatt auf den regulären Modell-Credittarif bis {until}.",
  "zcodeUsage.flashActive": "Kostenloses GLM-5.3-Flash-Zeitfenster über ZCode aktiv: kein Kontingentverbrauch bis {end}, sofern die Bedingungen unten erfüllt sind.",
  "zcodeUsage.flashNext": "Nächstes kostenloses GLM-5.3-Flash-Zeitfenster über ZCode: {start} – {end}.",
  "zcodeUsage.eligibility": "Erfordert einen kostenpflichtigen GLM Coding Plan, ZCode ab 3.10 und Restkontingent in BEIDEN Limits (5 Stunden und Woche). Guthaben und Berechtigung werden hier nicht geprüft. GLM-5.3 und andere Agenten sind von diesem Nullverbrauch ausgeschlossen.",
  "zcodeUsage.rules": "Spitzenzeit: Mo–Fr 14–18 Uhr Singapur; sonst Nebenzeit. Flash-Aktion: 3.–20. September 2026, täglich 23–9 Uhr Singapur. Der Hinweis endet vorsorglich am 20. September; eine Verlängerung der letzten Nacht ist nicht angegeben. Hinweise ändern keine Verbrauchs- oder Kostenberichte.",
  "zcodeUsage.source": "Offizielle Tarife · geprüft am 11. September 2026",
  "zcodeUsage.campaignSource": "Offizielle Aktionsbedingungen",
  "zcodeDesktop.providerPending": "Desktop-Protokoll geprüft, Anbieterregistrierung unvollständig. Aktivierung erneut versuchen; Einstellungen bleiben erhalten.",
  "zcodeDesktop.catalogPending": "Anbieter aktiviert, Codex-Katalog noch nicht bereit. Aktivierung erneut versuchen und bei fehlenden Modellen eigene Sichtbarkeitsfilter prüfen.",
  ...
  "zcodeAccounts.consent": "Ich erlaube die offizielle ZCode-Anmeldung und Verwaltung dieser Konten. Nach Anmeldung werden Anbieter und Katalog aktiviert, ohne Standardwerte zu ändern oder Inferenz auszuführen.",
  "zcodeAccounts.add": "Konto hinzufügen",
  "zcodeAccounts.loginHint": "Offizielle Anmeldung im Browser abschließen. Für ein anderes Konto dort wechseln oder ein privates Fenster nutzen. Der Link läuft ab; dieses Fenster offen lassen.",
  "zcodeAccounts.login": "Offizielle Anmeldung öffnen",
  "zcodeAccounts.failed": "Aktion fehlgeschlagen. Abgelaufene Anmeldung wiederholen, bestehende Konten erneut anmelden, aktive Aufgaben abwarten und Routing-Verweise vor dem Löschen entfernen.",
  "zcodeAccounts.pending": "Einrichtung unvollständig",
  "zcodeAccounts.reconnect": "Erneut anmelden",
  "zcodeAccounts.rename": "Umbenennen",
  "zcodeAccounts.remove": "Konto entfernen",
  "zcodeAccounts.removeConfirm": "Gespeichertes Konto und Anbieter entfernen? Aktive Aufgaben und Routing-Verweise müssen zuerst beendet werden.",
  ...
  "zcodeDesktop.open": "ZCode Desktop öffnen",
  "zcodeDesktop.detect": "Erneut erkennen",
  "zcodeDesktop.download": "ZCode herunterladen",
  "zcodeDesktop.location": "Desktop-Installationsordner (erweitert)",
  "zcodeDesktop.workspace": "Arbeitsordner",
  "zcodeDesktop.browse": "Ordner durchsuchen",
  "zcodeDesktop.up": "Übergeordneter Ordner",
  "zcodeDesktop.select": "Auswählen",
  "zcodeDesktop.consent": "Ich erlaube OpenCodex, offizielles ZCode in diesem Arbeitsbereich auszuführen, das Desktop-Profil zu lesen, den Anbieter zu aktivieren und den Codex-Katalog zu aktualisieren. Bei späteren Anfragen darf ZCode native Werkzeuge ausführen.",
  "zcodeDesktop.back": "Zurück",
  "zcodeDesktop.connect": "Desktop verbinden",
  "zcodeDesktop.disconnect": "Trennen",
  "zcodeDesktop.testHint": "Optional: Prüfen Sie das offizielle ZCode-Protokoll und das ausgewählte Modell erneut, ohne einen Modelllauf oder native Werkzeuge zu starten oder Kontingent zu verbrauchen.",
  "zcodeDesktop.model": "Modell",
  "zcodeDesktop.test": "Protokoll erneut prüfen",
  "zcodeDesktop.testPassed": "Die ZCode-Protokollprüfung war erfolgreich.",
  ...
  "zcodeDesktop.sandboxUnavailable": "Bubblewrap kann im Sicherheitskontext des Servers keine Sandbox erstellen. Lassen Sie User-Namespaces und AppArmor prüfen und starten Sie die Erkennung erneut. Die Isolation bleibt aktiv.",
  ...
  "zcodeDesktop.protocolFailed": "Die ZCode-Protokollprüfung wurde nicht abgeschlossen. Prüfen Sie Anmeldung und Modellzugriff in Desktop und verbinden Sie erneut. Es wurden weder Modelllauf noch natives Werkzeug noch direkter API-Ersatz verwendet.",
  "zcodeDesktop.failed": "Die offizielle Laufzeit konnte nicht verbunden werden. Prüfen Sie Desktop, den Ordner und die Isolationsvoraussetzungen.",
