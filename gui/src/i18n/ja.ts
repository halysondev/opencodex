...
"common.discard": "破棄",
 ...
 "quota.fiveHourLimit": "5 時間上限",
  ...
  "pws.copilotContextTier": "GitHub Copilot コンテキスト ティア",
  "pws.copilotContextTierDefault": "デフォルト コンテキスト",
  "pws.copilotContextTierLong": "長いコンテキスト (対応モデルのみ)",
  "pws.copilotContextTierDesc": "検出または設定済みの各 Copilot モデルのコンテキスト ティアを選択します。OpenCodex は対応している場合に選択したティアを転送し、プロバイダー cap は引き続きカタログ ウィンドウを制限します。",
  "pws.copilotContextTierNoModels": "Copilot モデルはまだ検出されていません。モデルを更新するか、「モデル」タブで設定してください。",
