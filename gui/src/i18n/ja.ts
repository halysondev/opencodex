...
export const ja: Record<TKey, string> = {
  ...
  "zcodeUsage.offPeak": "オフピーク：{until}まで通常のモデルクレジット料金が50%割引。",
  "zcodeUsage.flashActive": "ZCode経由のGLM-5.3-Flash無料時間帯が有効：以下の条件を満たす場合、{end}まで枠の消費なし。",
  "zcodeUsage.flashNext": "次のZCode経由GLM-5.3-Flash無料時間帯：{start} – {end}。",
  "zcodeUsage.eligibility": "有料GLM Coding Plan、ZCode 3.10以降、5時間枠と週間枠の両方に残量が必要です。残量・適用資格はここでは確認していません。GLM-5.3と他のエージェントは消費ゼロ特典の対象外です。",
  "zcodeUsage.rules": "ピーク：シンガポール時間の月～金14～18時。それ以外はオフピーク。Flashキャンペーン：2026年9月3～20日、毎日23～翌9時（シンガポール）。最終夜の延長は明記されていないため、安全側で9月20日末に表示を終了します。使用量・料金レポートは変更しません。",
  "zcodeUsage.source": "公式料金 · 2026年9月11日確認",
  "zcodeUsage.campaignSource": "公式キャンペーン条件",
  "zcodeDesktop.providerPending": "Desktop プロトコルは確認済みですが、プロバイダー登録は未完了です。有効化を再試行してください。設定は保持されます。",
  ...
  "zcodeAccounts.consent": "公式 ZCode ログインとアカウント管理を許可します。ログイン完了でプロバイダーとカタログを有効にします。既定値の変更や推論は行いません。",
  "zcodeAccounts.add": "アカウントを追加",
  "zcodeAccounts.loginHint": "ブラウザーで公式ログインを完了してください。別のアカウントには切替またはプライベートウィンドウを使用します。リンクは期限付きです。このパネルを開いたままにしてください。",
  "zcodeAccounts.login": "公式ログインを開く",
  "zcodeAccounts.failed": "操作を完了できません。期限切れは再ログイン、重複は再接続してください。実行中の作業を待ち、削除前にルーティング参照を除去してください。",
  "zcodeAccounts.pending": "設定未完了",
  "zcodeAccounts.reconnect": "再ログイン",
  ...
  "zcodeDesktop.open": "ZCode Desktop を開く",
  "zcodeDesktop.detect": "再検出",
  "zcodeDesktop.download": "ZCode をダウンロード",
  "zcodeDesktop.location": "Desktop インストール先（詳細）",
  "zcodeDesktop.workspace": "作業フォルダー",
  "zcodeDesktop.browse": "フォルダーを参照",
  "zcodeDesktop.up": "親フォルダー",
  "zcodeDesktop.select": "選択",
  "zcodeDesktop.consent": "このワークスペースで公式 ZCode を実行し、Desktop プロファイルを読み、プロバイダーを有効化して Codex カタログを更新することを許可します。後でリクエストを送ると ZCode がネイティブツールを実行する場合があります。",
  "zcodeDesktop.back": "戻る",
  "zcodeDesktop.connect": "Desktop に接続",
  "zcodeDesktop.disconnect": "切断",
  "zcodeDesktop.testHint": "任意：モデルターンやネイティブツールを開始せず、クォータも消費せずに、公式 ZCode プロトコルと選択したモデルを再確認します。",
  "zcodeDesktop.model": "モデル",
  "zcodeDesktop.test": "プロトコルを再確認",
  "zcodeDesktop.testPassed": "ZCode プロトコルの確認に成功しました。",
  ...
  "zcodeDesktop.protocolFailed": "ZCode プロトコルの確認が完了しませんでした。Desktop でログインとモデルの権限を確認して再接続してください。モデルターン、ネイティブツール、直接 API へのフォールバックは使用されていません。",
  "zcodeDesktop.failed": "公式ランタイムに接続できません。Desktop、フォルダー、隔離の前提条件を確認してください。",
