...
"skills.title": "スキル制御プレーン",
  "skills.subtitle": "ユニバーサルエージェントスキル登録、ビジュアルマーケットプレイス、ポリシー管理のデプロイ。",
  "skills.refresh": "更新",
  "skills.refreshing": "更新中…",
  "skills.tab.overview": "概要",
  "skills.tab.marketplace": "マーケットプレイス",
  "skills.tab.registry": "レジストリ ({count})",
  "skills.tab.editor": "スキルエディタ",
  "skills.tab.matrix": "デプロイ行列",
  "skills.tab.agents": "エージェント",
  "skills.tab.nodes": "リモートノード",
  "skills.tab.drift": "ドリフトとロールバック",
  "skills.tab.reviews": "レビュー待ち",
  "skills.tab.audit": "監査ログ",
  "skills.card.registered": "登録済みスキル",
  "skills.card.deployments": "稼働中のデプロイ",
  "skills.card.marketplace": "マーケットプレイス項目",
  "skills.card.audit": "監査イベント",
  "skills.recentActivity": "最近の制御プレーン活動",
  "skills.noEvents": "最近のイベントはありません。",
  "skills.col.timestamp": "時刻",
  "skills.col.event": "イベント",
  "skills.col.actor": "アクター",
  "skills.col.target": "対象",
  "skills.searchPlaceholder": "公開 skills.sh カタログを検索…",
  "skills.byAuthor": "v{version} / {author}",
  "skills.verified": "検証済み",
  "skills.importToRegistry": "レジストリへ取り込み",
  "skills.emptyRegistry": "スキルはまだ登録されていません。マーケットプレイスまたはローカルフォルダから取り込んでください。",
  "skills.col.skill": "スキル",
  "skills.col.version": "バージョン",
  "skills.col.status": "状態",
  "skills.col.risk": "リスク",
  "skills.col.tags": "タグ",
  "skills.col.actions": "操作",
  "skills.publish": "公開",
  "skills.deployCodex": "Codex へデプロイ",
  "skills.editorTitle": "SKILL.md エディタ",
  "skills.editorNamePlaceholder": "スキル名",
  "skills.editorVersionPlaceholder": "バージョン",
  "skills.editorDefaultName": "カスタムアシスタント",
  "skills.editorDefaultMarkdown": "---\nname: custom-assistant\ndisplayName: Custom Assistant\nversion: 1.0.0\ndescription: Custom guidance procedure.\ntags: custom, utility\n---\n\n# Custom Assistant\n\nInstructions for the agent.\n",
  "skills.saveDraft": "下書きを保存",
  "skills.previewTitle": "ライブプレビュー",
  "skills.matrixTitle": "フリートデプロイ行列",
  ...
  "skills.notInstalled": "未インストール",
  "skills.inSync": "v{version} 同期済み",
  "skills.blocked": "ブロック",
  "skills.agentsTitle": "対象エージェントフリート",
  "skills.col.agent": "エージェント",
  "skills.col.userRoot": "対象ルート（ユーザースコープ）",
  "skills.col.projectRoot": "対象ルート（プロジェクトスコープ）",
  "skills.col.adapterVersion": "アダプタ版",
  "skills.agent.openaiCodex": "OpenAI Codex",
  "skills.agent.universalAgent": "ユニバーサルエージェント",
  "skills.statusReady": "準備完了",
  "skills.nodesTitle": "リモート実行ノード (SSH)",
  "skills.nodesHelp": "ホスト鍵のピン留めを厳守して、リモート VPS、GPU ワーカー、開発ホストを管理します。",
  "skills.col.node": "ノード",
  "skills.col.type": "種類",
  "skills.col.host": "ホスト",
  "skills.col.environment": "環境",
  "skills.localMachine": "ローカルマシン",
  "skills.self": "自身",
  "skills.vpsMain": "VPS Main",
  "skills.testConnection": "接続テスト",
  "skills.driftTitle": "構成ドリフトとロールバック",
  "skills.driftHelp": "継続監視はライブディスクファイルを不変のレジストリハッシュと比較します。",
  "skills.col.deployment": "デプロイ",
  "skills.col.targetPath": "対象パス",
  "skills.col.driftState": "ドリフト状態",
  "skills.checkHash": "ハッシュ確認",
  "skills.reviewsTitle": "ポリシーと承認キュー",
  "skills.reviewsEmpty": "オペレータ判断が必要な保留中の昇格レビューはありません。",
  "skills.auditTitle": "監査ログ",
  "skills.col.eventType": "イベント種別",
  "skills.col.targetId": "対象 ID",
  "skills.system": "system",
  "skills.status.importing": "{id} を取り込み中…",
  "skills.status.imported": "{id} を取り込みました。",
  "skills.status.importFailed": "取り込み失敗: {error}",
  "skills.status.publishing": "{id} を公開中…",
  "skills.status.published": "{id} を公開しました。",
  "skills.status.publishFailed": "公開失敗: {error}",
  "skills.status.planning": "{id} を {agent} へデプロイする計画中…",
  "skills.status.deployed": "{id} を {agent} へデプロイしました。",
  "skills.status.deployFailed": "デプロイ失敗: {error}",
  "skills.status.saved": "スキル下書きをレジストリに保存しました。",
  "skills.status.saveFailed": "保存失敗: {error}",
  "skills.loadFailed": "スキル制御プレーンのデータを読み込めませんでした。",
  "security.title": "セキュリティ制御プレーン",
  "security.subtitle": "認可優先の偵察と検証。対象向け作業は既定で拒否。R3 はブロック。ハッシュで到達可能。サイドバー NAV 行ではありません。",
  "security.refresh": "更新",
  "security.refreshing": "更新中…",
  "security.banner": "認可済み対象のみ。未知の資産、期限切れの認可、除外ホストは拒否されます。第三者のライブツールは呼び出しません。偵察はローカルフィクスチャを使います。",
  "security.flagOff": "機能フラグ PAO_SECURITY_CONTROL_PLANE はオフです。変更は拒否されます。",
  "security.status.posting": "POST {path}",
  "security.status.ok": "OK {path}",
  "security.status.failed": "失敗: {error}",
  "security.evidence.campaign": "キャンペーンの証跡: {campaign}",
  "security.evidence.none": "アクティブなキャンペーンはありません",
  "security.tab.overview": "概要",
  "security.tab.authorizations": "認可",
  "security.tab.scopes": "スコープ",
  "security.tab.campaigns": "キャンペーン",
  "security.tab.approvals": "承認",
  "security.tab.findings": "検出",
  "security.tab.evidence": "証拠",
  "security.tab.skills": "パッケージ",
  "security.tab.tools": "ツール",
  "security.tab.mcp": "MCP",
  "security.tab.policies": "ポリシー",
  "security.tab.audit": "監査",
  "security.card.enabled": "有効",
  "security.card.campaigns": "キャンペーン",
  "security.card.approvals": "承認",
  "security.card.leads": "リード",
  "security.card.validated": "検証済み",
  "security.card.blocked": "ブロック",
  "security.card.authExpiring": "認可の期限切れ間近",
  "security.card.breakers": "サーキットブレーカ",
  "security.yes": "はい",
  "security.no": "いいえ",
  "security.col.id": "ID",
  "security.col.type": "種類",
  "security.col.status": "状態",
  "security.col.validUntil": "有効期限",
  "security.col.name": "名前",
  "security.col.actions": "操作",
  "security.col.target": "対象",
  "security.col.title": "タイトル",
  "security.col.severity": "重大度",
  "security.col.sha256": "SHA-256",
  "security.col.preview": "プレビュー",
  "security.col.compatibility": "互換性",
  "security.col.kind": "種別",
  "security.col.allowlisted": "許可リスト",
  "security.col.health": "健全性",
  "security.col.credential": "資格情報",
  "security.col.ceiling": "上限",
  "security.col.blockR3": "R3 をブロック",
  "security.col.when": "日時",
  "security.col.event": "イベント",
  "security.col.actor": "アクター",
  "security.start": "開始",
  "security.pause": "一時停止",
  "security.reconLab": "Recon lab.local",
  "security.approveOnce": "一度だけ承認",
  "security.deny": "拒否",
  "security.reasonBounded": "一度限り",
  "security.reasonDenied": "拒否",
  "security.hashes": "ブックマーク可能なハッシュ: {hashes}",
  "security.loadFailed": "セキュリティ制御プレーンのデータを読み込めませんでした。",
  "credentials.title": "プロバイダーアクセス制御プレーン",
  "credentials.subtitle": "暗号化された資格情報、ヘルスチェック済みトークンプール、OAuth ゲートウェイ、ポリシー管理リース。ハッシュで到達可能。サイドバー NAV 行ではありません。",
  "credentials.refresh": "更新",
  "credentials.refreshing": "更新中…",
  "credentials.banner": "秘密は平文では一覧表示されません。このフェーズのヘルスチェックはフィクスチャ／インプロセスです。このプレーンはプロバイダーアカウントを登録しません。",
  "credentials.flagOff": "機能フラグ CREDENTIAL_RUNTIME_ENABLED はオフです。変更は拒否されます。",
  "credentials.status.posting": "POST {path}",
  "credentials.status.ok": "OK {path}",
  "credentials.status.failed": "失敗: {error}",
  "credentials.tab.overview": "概要",
  "credentials.tab.list": "資格情報",
  "credentials.tab.providers": "プロバイダー",
  "credentials.tab.oauth": "OAuth",
  "credentials.tab.pool": "プール",
  "credentials.tab.health": "健全性",
  "credentials.tab.quota": "クォータ",
  "credentials.tab.policies": "ポリシー",
  "credentials.tab.approvals": "承認",
  "credentials.tab.audit": "監査",
  "credentials.card.enabled": "有効",
  "credentials.card.total": "合計",
  "credentials.card.healthy": "正常",
  "credentials.card.degraded": "低下",
  "credentials.card.quarantined": "隔離",
  "credentials.card.revoked": "取り消済み",
  "credentials.card.leases": "リース",
  "credentials.card.breakers": "ブレーカ",
  "credentials.card.vault": "ボールト",
  "credentials.yes": "はい",
  "credentials.no": "いいえ",
  "credentials.available": "利用可",
  "credentials.unavailable": "利用不可",
  "credentials.col.id": "ID",
  "credentials.col.name": "名前",
  "credentials.col.provider": "プロバイダー",
  "credentials.col.status": "状態",
  "credentials.col.health": "健全性",
  "credentials.col.secret": "秘密",
  "credentials.col.eligible": "適格",
  "credentials.col.actions": "操作",
  "credentials.col.score": "スコア",
  "credentials.col.adapter": "アダプター",
  "credentials.col.oauth": "OAuth",
  "credentials.col.enabled": "有効",
  "credentials.col.session": "セッション",
  "credentials.col.redirect": "リダイレクト",
  "credentials.col.budget": "予算",
  "credentials.col.priority": "優先度",
  "credentials.col.action": "アクション",
  "credentials.col.target": "対象",
  "credentials.col.when": "日時",
  "credentials.col.event": "イベント",
  "credentials.col.actor": "アクター",
  "credentials.col.decision": "判定",
  "credentials.validate": "検証",
  "credentials.quarantine": "隔離",
  "credentials.revoke": "取り消し",
  "credentials.healthRun": "ヘルスパスを実行",
  "credentials.approve": "承認",
  "credentials.reject": "拒否",
  "credentials.hashes": "ブックマーク可能なハッシュ: {hashes}",
  "credentials.loadFailed": "資格情報ランタイムのデータを読み込めませんでした。",
  "social.title": "ソーシャル公開コントロールプレーン",
  "social.subtitle": "エージェント主導のSNS公開オーケストレーション、マルチプラットフォーム版、OpenPost持続的スケジュール管理。",
    "social.tablist": "ソーシャル公開タブ",
"social.refresh": "更新",
  "social.refreshing": "更新中…",
  "social.banner": "OpenPostに接続中。OAuth秘密情報はOpenPost内で保護されます。公開前に人間の承認が必要です。",
  "social.flagOff": "機能フラグ SOCIAL_PUBLISHING_ENABLED が無効です — 変更は拒否されます。",
  "social.tab.overview": "概要",
  "social.tab.accounts": "アカウント",
  "social.tab.publications": "公開コンテンツ",
  "social.tab.approvals": "承認",
  "social.tab.jobs": "配信ジョブ",
  "social.tab.analytics": "アナリティクス",
  "social.tab.instances": "OpenPostインスタンス",
  "social.tab.audit": "監査ログ",
  "social.card.enabled": "有効",
  "social.card.instances": "インスタンス数",
  "social.card.accounts": "アカウント数",
  "social.card.readyAccounts": "準備完了",
  "social.card.publications": "公開件数",
  "social.card.scheduled": "予約済み",
  "social.card.pendingApprovals": "承認待ち",
  "social.card.failedDeliveries": "配信失敗",
  "social.yes": "はい",
  "social.no": "いいえ",
  "social.col.id": "ID",
  "social.col.platform": "プラットフォーム",
  "social.col.displayName": "表示名",
  "social.col.readiness": "準備状態",
  "social.col.enabled": "有効",
  "social.col.actions": "アクション",
  "social.col.sourceType": "ソース形式",
  "social.col.title": "タイトル",
  "social.col.status": "状態",
  "social.col.scheduledAt": "予約日時",
  "social.col.name": "名称",
  "social.col.baseUrl": "ベースURL",
  "social.col.version": "バージョン",
  "social.col.pubId": "公開ID",
  "social.col.jobType": "ジョブ種別",
  "social.col.attempts": "試行回数",
  "social.col.error": "エラー",
  "social.col.when": "日時",
  "social.col.actor": "アクター",
  "social.col.action": "操作",
  "social.col.resource": "リソース",
  "social.col.resourceId": "リソースID",
  "social.col.decision": "判定",
  "social.col.approver": "承認者",
  "social.col.approvalScope": "承認範囲",
  "social.col.contentHash": "コンテンツハッシュ",
  "social.col.account": "アカウント",
  "social.col.capturedAt": "取得日時",
  "social.col.views": "表示回数",
  "social.col.impressions": "インプレッション",
  "social.col.engagements": "エンゲージメント",
  "social.col.followersDelta": "フォロワー増減",
  "social.emptyAccounts": "接続アカウントがありません。OpenPostから同期してください。",
  "social.emptyPublications": "公開コンテンツはまだありません。",
  "social.emptyInstances": "OpenPostインスタンスが登録されていません。",
  "social.emptyJobs": "配信ジョブはありません。",
  "social.emptyAudit": "監査イベントはありません。",
  "social.emptyApprovals": "承認の記録はまだありません。",
  "social.emptyAnalytics": "分析スナップショットはまだありません。",
  "social.refreshCaps": "機能を更新",
  "social.validate": "検証",
  "social.approve": "承認",
  "social.publish": "今すぐ公開",
  "social.test": "接続テスト",
  "social.syncAccounts": "アカウント同期",
  "social.status.posting": "POST {path}",
  "social.status.ok": "OK {path}",
  "social.status.failed": "失敗: {error}",
  "social.hashes": "ブックマーク可能なハッシュ: {hashes}",
};
