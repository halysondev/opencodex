...
export const ja: Record<TKey, string> = {
  ...
  "zcodeDesktop.testHint": "任意：ZCode 経由で短いリクエストを1回送信し、モデルへのアクセスを確認します。割り当てを消費します。接続だけでは消費しません。",
  ...
  "zcodeDesktop.inferenceFailed": "ZCode のテストが完了しませんでした。Desktop でログインとモデルの権限を確認して再接続してください。直接 API へのフォールバックはありません。",
