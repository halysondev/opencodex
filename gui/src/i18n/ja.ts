...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "integrations.cursor.installerOpen": "インストーラーのページを開く",
  "integrations.cursor.installerUnavailable": "現在、Cursor のアップデートチャネルから Private Inference のインストーラーを解決できませんでした。Cursor が案内した時点で手動でインストールできます。下のゲートウェイ値はいずれの場合も有効です。",
