...
"common.discard": "Discard",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.copilotContextTier": "GitHub Copilot context tier",
  "pws.copilotContextTierDefault": "Default context",
  "pws.copilotContextTierLong": "Long context (when supported)",
  "pws.copilotContextTierDesc": "Choose a context tier for each detected or configured Copilot model. OpenCodex forwards the selected tier when supported; the provider cap still limits the catalog window.",
  "pws.copilotContextTierNoModels": "No Copilot models are detected yet. Refresh models or configure one in the Models tab.",
