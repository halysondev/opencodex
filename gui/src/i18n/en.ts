...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "guardrails.testerHint": "Scan locally with the effective registry. Text is not sent upstream or retained.",
  "guardrails.testerSimulation": "Local simulation only. Use synthetic test values; never paste real secrets. Text is not sent upstream or retained.",
