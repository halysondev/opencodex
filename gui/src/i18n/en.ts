...
export const en = {
  ...
  "zcodeDesktop.intro": "Connect the Z.AI models configured in ZCode Desktop on this computer. No API key to paste. OpenCodex starts the official runtime; it does not attach to an existing Desktop conversation.",
  "zcodeDesktop.connected": "Desktop connected · local protocol verified",
  ...
  "zcodeDesktop.consent": "I allow ZCode to edit files and run commands in this folder. Desktop settings are read-only. Commands have network access. Only connect a trusted official ZCode installation.",
  "zcodeDesktop.back": "Back",
  "zcodeDesktop.connect": "Connect Desktop",
  "zcodeDesktop.disconnect": "Disconnect",
  "zcodeDesktop.use": "Use this provider",
