...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "guardrails.title": "Sensitive data guardrails",
  "guardrails.subtitle": "Replace detected sensitive values with reversible placeholders before requests leave this proxy.",
  "guardrails.loading": "Loading Guardrails settings…",
  "guardrails.loadFailed": "Could not load Guardrails settings.",
  "guardrails.saveFailed": "Could not save Guardrails settings.",
  "guardrails.saved": "Guardrails settings saved.",
  "guardrails.statusActive": "Active",
  "guardrails.statusProtected": "Protected",
  "guardrails.statusDetectOnly": "Detect only",
  "guardrails.statusReducedCoverage": "Reduced coverage",
  "guardrails.statusUnavailable": "Registry unavailable",
  "guardrails.statusNoRules": "No active rules",
  "guardrails.statusNoProviderCoverage": "No providers protected",
  "guardrails.statusDisabled": "Disabled",
  "guardrails.valueOn": "On",
  "guardrails.valueOff": "Off",
  "guardrails.settingsTitle": "Request protection",
  "guardrails.settingsHint": "Changes are applied atomically to new requests. Existing streams keep their current mapping.",
  "guardrails.enabled": "Enable Guardrails",
  "guardrails.enabledHint": "Mask allowlisted prompt and tool fields before they reach an upstream provider.",
  "guardrails.mode": "Mode",
  "guardrails.modeEnforce": "Enforce masking",
  "guardrails.modeDetect": "Detect only",
  "guardrails.failurePolicy": "Processing failure",
  "guardrails.failureBlock": "Block request",
  "guardrails.failurePassthrough": "Pass through request",
  "guardrails.keywordPrefilter": "Keyword prefilter",
  "guardrails.keywordPrefilterHint": "Skip only built-in rules whose regex proves every match contains a declared keyword. Custom and unproven rules are always scanned.",
  "guardrails.reducedCoverageWarning": "Reduced coverage: some data types or built-in rules are disabled, provider coverage is limited, or processing failures may pass through.",
  "guardrails.providerScope": "Protected providers",
  "guardrails.providerScopeAllValue": "All providers",
  "guardrails.providerScopeSelectedValue": "Selected ({count})",
  "guardrails.importSecurityProviderScope": "Provider coverage: {before} → {after}",
  "guardrails.providerScopeAllHint": "All current and future providers are protected.",
  "guardrails.providerScopeSelectedHint": "Only checked providers are protected. New providers remain unprotected until selected.",
  "guardrails.providerAnthropicNative": "Anthropic (native)",
  "guardrails.providerDisabled": "disabled",
  "guardrails.providerNotConfigured": "not configured",
  "guardrails.lastProviderRequired": "Keep at least one provider selected, or disable Guardrails globally.",
  "guardrails.providerScopeWarning": "Provider coverage is limited. Requests routed to unchecked providers are not scanned or masked.",
  "guardrails.noProviderCoverageWarning": "No active provider is selected. Current provider traffic is not scanned or masked.",
  "guardrails.dialog.providerScope.title": "Limit provider coverage?",
  "guardrails.dialog.providerScope.changes": "New requests routed directly to the unchecked provider will no longer be scanned or masked.",
  "guardrails.dialog.providerScope.breakage": "Sensitive values may reach that provider unchanged. Protected continuations cannot cross this boundary.",
  "guardrails.dialog.providerScope.undo": "Re-select the provider in Guardrails Settings to restore protection.",
  "guardrails.dialog.providerScope.confirm": "Limit coverage",
  "guardrails.lastDataTypeRequired": "At least one data type must remain enabled.",
  ...
  "guardrails.dataType.personal": "Personal data",
  "guardrails.dataType.custom": "Custom",
  "guardrails.rulesTitle": "Rule management",
  "guardrails.rulesHint": "Disable a built-in rule or manage local custom rules. Built-in regexes are never exposed here.",
  "guardrails.selectBuiltin": "Select a built-in rule",
  "guardrails.disableBuiltin": "Disable rule",
  "guardrails.enableBuiltin": "Enable rule",
  "guardrails.noDisabledBuiltins": "No built-in rules are disabled.",
  "guardrails.customRules": "Custom rules",
  "guardrails.noCustomRules": "No custom rules yet.",
  "guardrails.addRule": "Add rule",
  "guardrails.editRule": "Edit rule",
  "guardrails.deleteRule": "Delete rule",
  "guardrails.removeRuleConfirm": "Delete custom rule {ruleId}?",
  "guardrails.ruleSaveFailed": "Could not save the custom rule.",
  "guardrails.ruleDeleteFailed": "Could not delete the custom rule.",
  "guardrails.ruleSaved": "Custom rule saved.",
  "guardrails.ruleDeleted": "Custom rule deleted.",
  "guardrails.ruleId": "Rule ID",
  "guardrails.ruleName": "Rule name",
  "guardrails.group": "Group",
  "guardrails.groupPriority": "Group priority",
  "guardrails.displayName": "Display name",
  "guardrails.description": "Description",
  "guardrails.regex": "RE2 pattern",
  "guardrails.placeholderType": "Placeholder type",
  "guardrails.captureGroups": "Capture groups",
  "guardrails.captureGroupsInvalid": "Use a comma-separated list of positive integer group numbers.",
  "guardrails.minLength": "Minimum length",
  "guardrails.entropy": "Entropy threshold",
  "guardrails.keywords": "Keywords",
  "guardrails.banlist": "Banlist",
  "guardrails.validators": "Validators",
  "guardrails.saveRule": "Save rule",
  "guardrails.cancelEdit": "Cancel",
  "guardrails.tabsLabel": "Guardrails sections",
  "guardrails.tab.overview": "Overview",
  "guardrails.tab.rules": "Rules",
  "guardrails.tab.tester": "Tester",
  "guardrails.tab.activity": "Activity",
  "guardrails.tab.settings": "Settings",
  "guardrails.detectWarning": "Detect mode reports findings but does not mask sensitive data before it leaves the proxy.",
  "guardrails.passthroughWarning": "Passthrough can send unmasked input upstream when Guardrails processing fails.",
  "guardrails.metric.scanned": "Requests scanned",
  "guardrails.metric.masked": "Values masked",
  "guardrails.metric.detected": "Values detected",
  "guardrails.metric.errors": "Warnings and blocks",
  "guardrails.registryReady": "Registry ready",
  "guardrails.registryFailed": "Registry failed",
  "guardrails.registryDisabled": "Registry disabled",
  "guardrails.effectiveRules": "{count} effective rule(s)",
  "guardrails.registryGeneration": "Generation {generation}",
  "guardrails.lastPassthrough": "Last passthrough incident: {date}",
  "guardrails.topRules": "Top rules",
  "guardrails.topCategories": "Top data categories",
  "guardrails.noActivity": "No Guardrails activity yet",
  "guardrails.noActivityHint": "Metadata appears here after protected requests are processed.",
  "guardrails.documentation": "Read the Guardrails documentation",
  "guardrails.searchRules": "Search rules",
  "guardrails.source": "Source",
  "guardrails.sourceOpenCodex": "OpenCodex rules",
  "guardrails.sourceManual": "Built in",
  "guardrails.sourceGitleaks": "Gitleaks rules",
  "guardrails.allSources": "All sources",
  "guardrails.status": "Status",
  "guardrails.allStatuses": "All statuses",
  "guardrails.allDataTypes": "All data types",
  "guardrails.filteredRules": "{count} filtered rule(s)",
  ...
  "guardrails.importReplace": "Replace",
  "guardrails.importFailed": "Could not import Guardrails rules.",
  "guardrails.importTooLarge": "Guardrails import files must be 4 MiB or smaller.",
  "guardrails.imported": "Guardrails rules imported.",
  "guardrails.importPreviewTitle": "Import preview",
  "guardrails.importSecurityTitle": "Security settings",
  "guardrails.importSecurityWeakening": "This import reduces protection. Review every highlighted change before continuing.",
  "guardrails.importSecurityPotential": "This import changes security-relevant custom rule definitions and may reduce protection. Review them before continuing.",
  "guardrails.importSecurityUnchanged": "No Guardrails security settings will change.",
  "guardrails.importSecurityEnabled": "Traffic protection: {before} → {after}",
  "guardrails.importSecurityMode": "Mode: {before} → {after}",
  "guardrails.importSecurityFailure": "Failure handling: {before} → {after}",
  "guardrails.importSecurityDataTypes": "Enabled data types: {before} → {after}",
  "guardrails.importSecurityDisabledRules": "Disabled built-in rules: {before} → {after} (newly disabled: {disabled}, re-enabled: {reenabled})",
  "guardrails.importSecurityCustomRules": "Custom rules: {before} → {after} (removed: {removed}, changed: {changed})",
  "guardrails.importSecurityChangedRuleIds": "Changed rule definitions:",
  "guardrails.importSecurityRemovedRuleIds": "Removed rule IDs:",
  "guardrails.importSecurityPrefilter": "Keyword prefilter: {before} → {after}",
  "guardrails.importSecurityReduced": "Reduced protection",
  "guardrails.importSecurityReviewRequired": "Security review required",
  "guardrails.importSecurityRemovedTypes": "No longer covered: {types}",
  "guardrails.importCreateCount": "Create: {count}",
  "guardrails.importReplaceCount": "Replace: {count}",
  "guardrails.importUnchangedCount": "Unchanged: {count}",
  "guardrails.importConflicts": "{count} conflicting rule IDs must be resolved before import.",
  "guardrails.importApply": "Apply import",
  "guardrails.noRules": "No rules match these filters.",
  "guardrails.previous": "Previous",
  "guardrails.next": "Next",
  "guardrails.page": "Page {current} of {total}",
  "guardrails.testerTitle": "Sensitive data tester",
  "guardrails.testerHint": "Scan with the effective registry on this OpenCodex instance. The sample is sent to its Management API, never to an LLM provider, and is not stored server-side.",
  "guardrails.testerSimulation": "Tester simulation only. Use synthetic values; never paste real secrets. In connected mode the sample may traverse your OpenCodex hub.",
  "guardrails.testerTrafficDisabled": "Real traffic protection is disabled. Requests currently leave the proxy without Guardrails masking.",
  "guardrails.testerTrafficDetect": "Real traffic is detect-only and is not masked before it reaches the provider.",
  "guardrails.testerTrafficUnknown": "Real traffic protection status is still unknown. Wait for Guardrails status to load before relying on it.",
  "guardrails.testerTrafficUnavailable": "Real traffic protection is unavailable. Resolve the Guardrails activation or registry failure before relying on masking.",
  "guardrails.testerTrafficNoRules": "Real traffic has no active Guardrails rules. Enable at least one effective rule before relying on masking.",
  "guardrails.testerTrafficNoProviderCoverage": "The simulation can find matches, but no active provider is currently selected for traffic protection.",
  "guardrails.testerTrafficReduced": "Real traffic uses reduced protection. Review disabled rules, data types, provider coverage, and failure policy before relying on masking.",
  "guardrails.testerDraftSettings": "Use draft settings",
  "guardrails.testerDraftSettingsHint": "Test another data-type and keyword-prefilter selection without saving it.",
  "guardrails.testerInput": "Text to scan",
  "guardrails.testerPlaceholder": "Paste sample text here…",
  "guardrails.byteCounter": "{current} / {max} bytes",
  "guardrails.clear": "Clear",
  "guardrails.test": "Scan",
  "guardrails.testing": "Scanning…",
  "guardrails.testerFailed": "Could not scan the text.",
  "guardrails.testerResult": "Scan result",
  "guardrails.effective": "Effective settings",
  "guardrails.draft": "Draft settings",
  "guardrails.findings": "Findings",
  "guardrails.noFindings": "Enabled rules found no matches; this does not guarantee the text contains no sensitive data.",
  "guardrails.placeholder": "Placeholder",
  "guardrails.offsets": "Offsets",
  "guardrails.activityTitle": "Guardrails activity",
  "guardrails.activityPrivacy": "In-memory metadata only; this is not an audit log. Prompt text and placeholder mappings are never stored here.",
  "guardrails.category": "Category",
  "guardrails.allCategories": "All categories",
  "guardrails.generation": "Generation",
  "guardrails.activitySummary": "Filtered activity summary",
  "guardrails.activityEvents": "Events: {count}",
  "guardrails.activityFindings": "Findings: {count}",
  "guardrails.activityAverageLatency": "Average latency: {value} ms",
  "guardrails.activityTopRule": "Top rule: {rule}",
  "guardrails.recentActivity": "Recent activity",
  "guardrails.surface": "Surface",
  "guardrails.surfaceCompact": "Compact",
  "guardrails.allSurfaces": "All surfaces",
  "guardrails.allModes": "All modes",
  "guardrails.result": "Result",
  "guardrails.allResults": "All results",
  "guardrails.result.scanned": "Scanned",
  "guardrails.result.masked": "Masked",
  "guardrails.result.detected": "Detected",
  "guardrails.result.blocked": "Blocked",
  "guardrails.result.passthrough": "Passed through",
  "guardrails.result.demaskWarning": "Demask warning",
  "guardrails.result.toolSkipped": "Tool restore skipped",
  "guardrails.refresh": "Refresh",
  "guardrails.retentionEvents": "{current} of {max} events retained",
  "guardrails.retentionEvicted": "{count} event(s) evicted",
  "guardrails.showingEvents": "Showing {shown} of {total} matching event(s)",
  "guardrails.oldestEvent": "Oldest retained event: {date}",
  "guardrails.lastRefresh": "Last refresh: {date}",
  "guardrails.tableScrollHint": "Scroll the table horizontally to see every column.",
  "guardrails.time": "Time",
  "guardrails.count": "Count",
  "guardrails.rules": "Rules",
  "guardrails.latency": "Latency",
  "guardrails.dialog.disable.title": "Disable Guardrails?",
  "guardrails.dialog.disable.changes": "New requests will no longer be scanned or masked.",
  "guardrails.dialog.disable.breakage": "Sensitive values may leave this proxy unchanged.",
  "guardrails.dialog.disable.undo": "Turn Guardrails back on in Overview or Settings.",
  "guardrails.dialog.disable.confirm": "Disable",
  "guardrails.dialog.detect.title": "Switch to detect-only mode?",
  "guardrails.dialog.detect.changes": "Findings will be counted, but request text will not be masked.",
  "guardrails.dialog.detect.breakage": "Detect mode does not protect data sent upstream.",
  "guardrails.dialog.detect.undo": "Switch the mode back to Enforce.",
  "guardrails.dialog.detect.confirm": "Use detect mode",
  "guardrails.dialog.passthrough.title": "Allow passthrough on failure?",
  "guardrails.dialog.passthrough.changes": "A Guardrails processing failure will forward the original request.",
  "guardrails.dialog.passthrough.breakage": "The failed request can contain unmasked sensitive values.",
  "guardrails.dialog.passthrough.undo": "Set failure handling back to Block request.",
  "guardrails.dialog.passthrough.confirm": "Allow passthrough",
  "guardrails.dialog.ruleDisable.title": "Disable rule {ruleId}?",
  "guardrails.dialog.ruleDisable.changes": "This built-in rule will stop scanning new requests.",
  "guardrails.dialog.ruleDisable.breakage": "Values detected only by this rule will no longer be protected.",
  "guardrails.dialog.ruleDisable.undo": "Enable the rule again from the Rules tab.",
  "guardrails.dialog.ruleDisable.confirm": "Disable rule",
  "guardrails.dialog.categoryDisable.title": "Disable a data category?",
  "guardrails.dialog.categoryDisable.changes": "Rules in this category will stop scanning new requests.",
  "guardrails.dialog.categoryDisable.breakage": "Sensitive values covered only by this category may leave the proxy unchanged.",
  "guardrails.dialog.categoryDisable.undo": "Enable the category again in Guardrails Settings.",
  "guardrails.dialog.categoryDisable.confirm": "Disable category",
  "guardrails.dialog.prefilter.title": "Enable the keyword prefilter?",
  "guardrails.dialog.prefilter.changes": "Rules with keywords may be skipped when their keywords are absent from the candidate text.",
  "guardrails.dialog.prefilter.breakage": "This performance trade-off can reduce detection recall.",
  "guardrails.dialog.prefilter.undo": "Turn the keyword prefilter off in Guardrails Settings.",
  "guardrails.dialog.prefilter.confirm": "Enable prefilter",
  "guardrails.dialog.bulkDisable.title": "Disable {count} rules?",
  "guardrails.dialog.bulkDisable.changes": "Every filtered built-in rule in this selection will be disabled.",
  "guardrails.dialog.bulkDisable.breakage": "Sensitive values covered only by these rules may leave the proxy unchanged.",
  "guardrails.dialog.bulkDisable.undo": "Enable the rules again from the Rules tab or import a prior export.",
  "guardrails.dialog.bulkDisable.confirm": "Disable rules",
  "guardrails.dialog.delete.title": "Delete custom rule {ruleId}?",
  "guardrails.dialog.delete.changes": "The custom rule will be removed from the effective registry.",
  "guardrails.dialog.delete.breakage": "Values detected only by this rule will no longer be protected.",
  "guardrails.dialog.delete.undo": "Import or recreate the rule to restore it.",
  "guardrails.dialog.delete.confirm": "Delete rule",
  "guardrails.dialog.import.title": "Replace all Guardrails rules?",
  "guardrails.dialog.import.changes": "The imported bundle will replace current Guardrails settings and custom rules.",
  "guardrails.dialog.import.breakage": "Local rules absent from the bundle will be removed.",
  "guardrails.dialog.import.undo": "Export the current bundle before replacing it.",
  "guardrails.dialog.import.confirm": "Replace rules",
  "guardrails.dialog.importWeakening.title": "Apply an import that reduces protection?",
  "guardrails.dialog.importWeakening.changes": "The imported bundle will replace Guardrails settings and custom rules with the previewed values.",
  "guardrails.dialog.importWeakening.breakage": "One or more highlighted settings will allow additional sensitive values to reach providers unchanged.",
  "guardrails.dialog.importWeakening.undo": "Export the current bundle before applying this import.",
  "guardrails.dialog.importWeakening.confirm": "Apply reduced protection",} as const;
