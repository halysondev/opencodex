...
"skills.title": "Skill Control Plane",
  "skills.subtitle": "Universal Agent Skill Registry, visual marketplace, and policy-governed deployment.",
  "skills.refresh": "Refresh",
  "skills.refreshing": "Refreshing…",
  "skills.tab.overview": "Overview",
  "skills.tab.marketplace": "Marketplace",
  "skills.tab.registry": "Registry ({count})",
  "skills.tab.editor": "Skill Editor",
  "skills.tab.matrix": "Deployment Matrix",
  "skills.tab.agents": "Agents",
  "skills.tab.nodes": "Remote Nodes",
  "skills.tab.drift": "Drift & Rollback",
  "skills.tab.reviews": "Review Queue",
  "skills.tab.audit": "Audit Trail",
  "skills.card.registered": "Registered Skills",
  "skills.card.deployments": "Active Deployments",
  "skills.card.marketplace": "Marketplace Items",
  "skills.card.audit": "Audit Events",
  "skills.recentActivity": "Recent control-plane activity",
  "skills.noEvents": "No recent events recorded.",
  "skills.col.timestamp": "Timestamp",
  "skills.col.event": "Event",
  "skills.col.actor": "Actor",
  "skills.col.target": "Target",
  "skills.searchPlaceholder": "Search the public skills.sh catalog…",
  "skills.byAuthor": "v{version} by {author}",
  "skills.verified": "Verified",
  "skills.importToRegistry": "Import to registry",
  "skills.emptyRegistry": "No skills registered yet. Import one from Marketplace or a local folder.",
  ...
  "skills.inSync": "v{version} in sync",
  "skills.blocked": "Blocked",
  "skills.agentsTitle": "Target agent fleet",
  "skills.col.agent": "Agent",
  "skills.col.userRoot": "Target root (user scope)",
  "skills.col.projectRoot": "Target root (project scope)",
  "skills.col.adapterVersion": "Adapter version",
  "skills.agent.openaiCodex": "OpenAI Codex",
  "skills.agent.universalAgent": "Universal Agent",
  "skills.statusReady": "Ready",
  "skills.nodesTitle": "Remote execution nodes (SSH)",
  "skills.nodesHelp": "Manage remote VPS, GPU workers, and development hosts with strict host-key pinning.",
  "skills.col.node": "Node",
  "skills.col.type": "Type",
  "skills.col.host": "Host",
  "skills.col.environment": "Environment",
  "skills.localMachine": "Local machine",
  "skills.self": "Self",
  "skills.vpsMain": "VPS Main",
  "skills.testConnection": "Test connection",
  "skills.driftTitle": "Configuration drift and rollback",
  "skills.driftHelp": "Continuous monitoring compares live disk files against immutable registry content hashes.",
  "skills.col.deployment": "Deployment",
  "skills.col.targetPath": "Target path",
  "skills.col.driftState": "Drift state",
  "skills.checkHash": "Check hash",
  "skills.reviewsTitle": "Policy and approval queue",
  "skills.reviewsEmpty": "No pending elevated reviews require an operator decision.",
  "skills.auditTitle": "Audit log",
  "skills.col.eventType": "Event type",
  "skills.col.targetId": "Target ID",
  "skills.system": "system",
  "skills.status.importing": "Importing {id}…",
  "skills.status.imported": "Imported {id}.",
  "skills.status.importFailed": "Import failed: {error}",
  "skills.status.publishing": "Publishing {id}…",
  "skills.status.published": "Published {id}.",
  "skills.status.publishFailed": "Publish failed: {error}",
  "skills.status.planning": "Planning deployment for {id} to {agent}…",
  "skills.status.deployed": "Deployed {id} to {agent}.",
  "skills.status.deployFailed": "Deploy failed: {error}",
  "skills.status.saved": "Skill draft saved to the registry.",
  "skills.status.saveFailed": "Save failed: {error}",
  "skills.loadFailed": "Could not load skill control plane data.",
  "security.title": "Security Control Plane",
  "security.subtitle": "Authorization-first recon and validation. Target-facing work is deny-by-default. R3 is blocked. Hash-routable; not a sidebar NAV row.",
  "security.refresh": "Refresh",
  "security.refreshing": "Refreshing…",
  "security.banner": "Authorized targets only. Unknown assets, expired authorizations, and excluded hosts deny. Live third-party tools are not invoked; recon uses local fixtures.",
  "security.flagOff": "Feature flag PAO_SECURITY_CONTROL_PLANE is off — mutations are refused.",
  "security.status.posting": "POST {path}",
  "security.status.ok": "OK {path}",
  "security.status.failed": "Failed: {error}",
  "security.evidence.campaign": "Campaign evidence: {campaign}",
  "security.evidence.none": "No active campaign",
  "security.tab.overview": "Overview",
  "security.tab.authorizations": "Authorizations",
  "security.tab.scopes": "Scopes",
  "security.tab.campaigns": "Campaigns",
  "security.tab.approvals": "Approvals",
  "security.tab.findings": "Findings",
  "security.tab.evidence": "Evidence",
  "security.tab.skills": "Packages",
  "security.tab.tools": "Tools",
  "security.tab.mcp": "MCP",
  "security.tab.policies": "Policies",
  "security.tab.audit": "Audit",
  "security.card.enabled": "Enabled",
  "security.card.campaigns": "Campaigns",
  "security.card.approvals": "Approvals",
  "security.card.leads": "Leads",
  "security.card.validated": "Validated",
  "security.card.blocked": "Blocked",
  "security.card.authExpiring": "Auth expiring",
  "security.card.breakers": "Breakers",
  "security.yes": "yes",
  "security.no": "no",
  "security.col.id": "ID",
  "security.col.type": "Type",
  "security.col.status": "Status",
  "security.col.validUntil": "Valid until",
  "security.col.name": "Name",
  "security.col.actions": "Actions",
  "security.col.target": "Target",
  "security.col.title": "Title",
  "security.col.severity": "Severity",
  "security.col.sha256": "SHA-256",
  "security.col.preview": "Preview",
  "security.col.compatibility": "Compatibility",
  "security.col.kind": "Kind",
  "security.col.allowlisted": "Allowlisted",
  "security.col.health": "Health",
  "security.col.credential": "Credential",
  "security.col.ceiling": "Ceiling",
  "security.col.blockR3": "Block R3",
  "security.col.when": "When",
  "security.col.event": "Event",
  "security.col.actor": "Actor",
  "security.start": "Start",
  "security.pause": "Pause",
  "security.reconLab": "Recon lab.local",
  "security.approveOnce": "Approve once",
  "security.deny": "Deny",
  "security.reasonBounded": "bounded once",
  "security.reasonDenied": "denied",
  "security.hashes": "Bookmarkable hashes: {hashes}",
  "security.loadFailed": "Could not load security control plane data.",
  "credentials.title": "Provider Access Control Plane",
  "credentials.subtitle": "Encrypted credentials, health-checked token pool, OAuth gateway, and policy-governed leases. Hash-routable; not a sidebar NAV row.",
  "credentials.refresh": "Refresh",
  "credentials.refreshing": "Refreshing…",
  "credentials.banner": "Secrets are never listed in plaintext. Health checks in this phase are fixture/in-process. This plane does not register provider accounts.",
  "credentials.flagOff": "Feature flag CREDENTIAL_RUNTIME_ENABLED is off — mutations are refused.",
  "credentials.status.posting": "POST {path}",
  "credentials.status.ok": "OK {path}",
  "credentials.status.failed": "Failed: {error}",
  "credentials.tab.overview": "Overview",
  "credentials.tab.list": "Credentials",
  "credentials.tab.providers": "Providers",
  "credentials.tab.oauth": "OAuth",
  "credentials.tab.pool": "Pool",
  "credentials.tab.health": "Health",
  "credentials.tab.quota": "Quota",
  "credentials.tab.policies": "Policies",
  "credentials.tab.approvals": "Approvals",
  "credentials.tab.audit": "Audit",
  "credentials.card.enabled": "Enabled",
  "credentials.card.total": "Total",
  "credentials.card.healthy": "Healthy",
  "credentials.card.degraded": "Degraded",
  "credentials.card.quarantined": "Quarantined",
  "credentials.card.revoked": "Revoked",
  "credentials.card.leases": "Leases",
  "credentials.card.breakers": "Breakers",
  "credentials.card.vault": "Vault",
  "credentials.yes": "yes",
  "credentials.no": "no",
  "credentials.available": "available",
  "credentials.unavailable": "unavailable",
  "credentials.col.id": "ID",
  "credentials.col.name": "Name",
  "credentials.col.provider": "Provider",
  "credentials.col.status": "Status",
  "credentials.col.health": "Health",
  "credentials.col.secret": "Secret",
  "credentials.col.eligible": "Eligible",
  "credentials.col.actions": "Actions",
  "credentials.col.score": "Score",
  "credentials.col.adapter": "Adapter",
  "credentials.col.oauth": "OAuth",
  "credentials.col.enabled": "Enabled",
  "credentials.col.session": "Session",
  "credentials.col.redirect": "Redirect",
  "credentials.col.budget": "Budget",
  "credentials.col.priority": "Priority",
  "credentials.col.action": "Action",
  "credentials.col.target": "Target",
  "credentials.col.when": "When",
  "credentials.col.event": "Event",
  "credentials.col.actor": "Actor",
  "credentials.col.decision": "Decision",
  "credentials.validate": "Validate",
  "credentials.quarantine": "Quarantine",
  "credentials.revoke": "Revoke",
  "credentials.healthRun": "Run health pass",
  "credentials.approve": "Approve",
  "credentials.reject": "Reject",
  "credentials.hashes": "Bookmarkable hashes: {hashes}",
  "credentials.loadFailed": "Could not load credential runtime data.",
  "social.title": "Social Publishing Control Plane",
  "social.subtitle": "Agentic social publishing orchestration, multi-platform renditions, and durable OpenPost scheduling.",
    "social.tablist": "Social publishing tabs",
"social.refresh": "Refresh",
  "social.refreshing": "Refreshing…",
  "social.banner": "Connected to OpenPost. Provider OAuth secrets remain protected inside OpenPost. Human approval required before publication.",
  "social.flagOff": "Feature flag SOCIAL_PUBLISHING_ENABLED is off — mutations are refused.",
  "social.tab.overview": "Overview",
  "social.tab.accounts": "Accounts",
  "social.tab.publications": "Publications",
  "social.tab.approvals": "Approvals",
  "social.tab.jobs": "Delivery Jobs",
  "social.tab.analytics": "Analytics",
  "social.tab.instances": "OpenPost Instances",
  "social.tab.audit": "Audit Trail",
  "social.card.enabled": "Enabled",
  "social.card.instances": "Instances",
  "social.card.accounts": "Accounts",
  "social.card.readyAccounts": "Ready Accounts",
  "social.card.publications": "Publications",
  "social.card.scheduled": "Scheduled",
  "social.card.pendingApprovals": "Pending Approvals",
  "social.card.failedDeliveries": "Failed Deliveries",
  "social.yes": "yes",
  "social.no": "no",
  "social.col.id": "ID",
  "social.col.platform": "Platform",
  "social.col.displayName": "Display Name",
  "social.col.readiness": "Readiness",
  "social.col.enabled": "Enabled",
  "social.col.actions": "Actions",
  "social.col.sourceType": "Source Type",
  "social.col.title": "Title",
  "social.col.status": "Status",
  "social.col.scheduledAt": "Scheduled At",
  "social.col.name": "Name",
  "social.col.baseUrl": "Base URL",
  "social.col.version": "Version",
  "social.col.pubId": "Publication",
  "social.col.jobType": "Job Type",
  "social.col.attempts": "Attempts",
  "social.col.error": "Error",
  "social.col.when": "Timestamp",
  "social.col.actor": "Actor",
  "social.col.action": "Action",
  "social.col.resource": "Resource",
  "social.col.resourceId": "Resource ID",
  "social.col.decision": "Decision",
  "social.col.approver": "Approver",
  "social.col.approvalScope": "Approval Scope",
  "social.col.contentHash": "Content Hash",
  "social.col.account": "Account",
  "social.col.capturedAt": "Captured At",
  "social.col.views": "Views",
  "social.col.impressions": "Impressions",
  "social.col.engagements": "Engagements",
  "social.col.followersDelta": "Followers Δ",
  "social.emptyAccounts": "No connected social accounts found. Sync accounts from an OpenPost instance.",
  "social.emptyPublications": "No publications created yet.",
  "social.emptyInstances": "No OpenPost instances registered.",
  "social.emptyJobs": "No delivery jobs recorded.",
  "social.emptyAudit": "No social audit events recorded.",
  "social.emptyApprovals": "No approvals recorded yet.",
  "social.emptyAnalytics": "No analytics snapshots recorded yet.",
  "social.refreshCaps": "Refresh capabilities",
  "social.validate": "Validate",
  "social.approve": "Approve",
  "social.publish": "Publish now",
  "social.test": "Test connection",
  "social.syncAccounts": "Sync accounts",
  "social.status.posting": "POST {path}",
  "social.status.ok": "OK {path}",
  "social.status.failed": "Failed: {error}",
  "social.hashes": "Bookmarkable hashes: {hashes}",
} as const;
