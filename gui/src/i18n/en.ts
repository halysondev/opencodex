...
export const en = {
  ...
  "zcodeDesktop.testHint": "Optional: send one short request through ZCode to verify model access. This consumes account quota; connecting alone does not.",
  ...
  "zcodeDesktop.inferenceFailed": "ZCode did not complete the test. Check login and model access in Desktop, then reconnect. No direct API fallback was used.",
