...
"codexSet.dialog.notRendered": "This layer sent nothing on the turn we read. Sections are only re-sent when they change, so an unchanged layer is absent from a single sample.",
  ...
  "integrations.cursor.installerOpen": "Open the installer page",
  "integrations.cursor.installerUnavailable": "The Private Inference installer could not be resolved from Cursor's update channel right now. It can be installed by hand once Cursor's updater offers it; the gateway values below stay valid either way.",
