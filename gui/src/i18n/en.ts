...
export const en = {
  ...
  "zcodeUsage.offPeak": "Off-peak: 50% off the standard model credit rate until {until}.",
  "zcodeUsage.flashActive": "GLM-5.3-Flash free window active through ZCode: zero quota consumption until {end}, subject to eligibility below.",
  "zcodeUsage.flashNext": "Next GLM-5.3-Flash free window through ZCode: {start} – {end}.",
  "zcodeUsage.eligibility": "Requires a paid GLM Coding Plan, ZCode 3.10 or later, and remaining quota in BOTH the 5-hour and weekly limits. Balance and eligibility are not verified here. GLM-5.3 and other agents are not covered by this zero-quota benefit.",
  "zcodeUsage.rules": "Peak: Mon–Fri 14:00–18:00 Singapore; all other hours are off-peak. Flash campaign: September 3–20, 2026, daily 23:00–09:00 Singapore. We conservatively stop the notice at the end of September 20; the final overnight extension is not specified. Advisories do not modify usage or cost reports.",
  "zcodeUsage.source": "Official rates · verified September 11, 2026",
  "zcodeUsage.campaignSource": "Official campaign conditions",
  "zcodeDesktop.providerPending": "Desktop protocol verified, but provider registration is incomplete. Retry activation; existing settings are preserved.",
  ...
  "zcodeAccounts.consent": "I authorize official ZCode login and management of these saved accounts. Completing login enables that account’s provider and catalog without changing defaults or sending inference.",
  "zcodeAccounts.add": "Add account",
  "zcodeAccounts.loginHint": "Complete the official login in the browser. For a different account, switch accounts there or use a private window. This link expires; keep this panel open.",
  "zcodeAccounts.login": "Open official login",
  "zcodeAccounts.failed": "Could not complete this action. Retry login if expired; reconnect duplicates, wait for active tasks, and remove routing references before deleting an account.",
  "zcodeAccounts.pending": "Account setup incomplete",
  "zcodeAccounts.reconnect": "Sign in again",
  ...
  "zcodeDesktop.open": "Open ZCode Desktop",
  "zcodeDesktop.detect": "Detect again",
  "zcodeDesktop.download": "Download ZCode",
  "zcodeDesktop.location": "Desktop installation folder (advanced)",
  "zcodeDesktop.workspace": "Workspace folder",
  "zcodeDesktop.browse": "Browse folders",
  "zcodeDesktop.up": "Parent folder",
  "zcodeDesktop.select": "Select",
  "zcodeDesktop.consent": "I allow OpenCodex to run official ZCode in this workspace, read the Desktop profile, enable the ZCode provider and update the Codex catalog. ZCode may execute native tools when I later send a request.",
  "zcodeDesktop.back": "Back",
  "zcodeDesktop.connect": "Connect Desktop",
  "zcodeDesktop.disconnect": "Disconnect",
  "zcodeDesktop.testHint": "Optional: recheck the official ZCode protocol and selected model without starting a model turn, running native tools, or consuming quota.",
  "zcodeDesktop.model": "Model",
  "zcodeDesktop.test": "Verify protocol again",
  "zcodeDesktop.testPassed": "ZCode protocol verification passed.",
  ...
  "zcodeDesktop.protocolFailed": "ZCode protocol verification did not complete. Check login and model access in Desktop, then reconnect. No model turn, native tool, or direct API fallback was used.",
  "zcodeDesktop.failed": "Could not connect to the official runtime. Check Desktop, the selected folder and the isolation prerequisites, then retry.",
