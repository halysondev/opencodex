...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "guardrails.title": "민감한 데이터 보호",
  "guardrails.subtitle": "요청이 이 프록시를 벗어나기 전에 감지된 민감한 값을 복원 가능한 자리표시자로 바꿉니다.",
  "guardrails.loading": "Guardrails 설정을 불러오는 중…",
  "guardrails.loadFailed": "Guardrails 설정을 불러오지 못했습니다.",
  "guardrails.saveFailed": "Guardrails 설정을 저장하지 못했습니다.",
  "guardrails.saved": "Guardrails 설정을 저장했습니다.",
  "guardrails.statusActive": "활성",
  "guardrails.statusDisabled": "비활성",
  "guardrails.settingsTitle": "요청 보호",
  "guardrails.settingsHint": "변경 사항은 새 요청에 원자적으로 적용됩니다. 기존 스트림은 현재 매핑을 유지합니다.",
  "guardrails.enabled": "Guardrails 활성화",
  "guardrails.enabledHint": "허용 목록에 있는 프롬프트 및 도구 필드를 업스트림 제공자에게 도달하기 전에 마스킹합니다.",
  "guardrails.mode": "모드",
  "guardrails.modeEnforce": "마스킹 강제",
  "guardrails.modeDetect": "감지만",
  "guardrails.failurePolicy": "처리 실패 시",
  "guardrails.failureBlock": "요청 차단",
  "guardrails.failurePassthrough": "요청을 그대로 전달",
  "guardrails.keywordPrefilter": "키워드 사전 필터",
  "guardrails.keywordPrefilterHint": "모든 일치 항목에 키워드가 포함됨이 정규식으로 증명된 기본 규칙만 건너뜁니다. 사용자 지정 및 증명되지 않은 규칙은 항상 검사합니다.",
  ...
  "guardrails.dataType.personal": "개인 데이터",
  "guardrails.dataType.custom": "사용자 지정",
  "guardrails.rulesTitle": "규칙 관리",
  "guardrails.rulesHint": "기본 제공 규칙을 비활성화하거나 로컬 사용자 지정 규칙을 관리합니다. 기본 제공 정규식은 여기에 표시되지 않습니다.",
  "guardrails.selectBuiltin": "기본 제공 규칙 선택",
  "guardrails.disableBuiltin": "규칙 비활성화",
  "guardrails.enableBuiltin": "규칙 활성화",
  "guardrails.noDisabledBuiltins": "비활성화된 기본 제공 규칙이 없습니다.",
  "guardrails.customRules": "사용자 지정 규칙",
  "guardrails.noCustomRules": "아직 사용자 지정 규칙이 없습니다.",
  "guardrails.addRule": "규칙 추가",
  "guardrails.editRule": "규칙 편집",
  "guardrails.deleteRule": "규칙 삭제",
  "guardrails.removeRuleConfirm": "사용자 지정 규칙 {ruleId}을(를) 삭제하시겠습니까?",
  "guardrails.ruleSaveFailed": "사용자 지정 규칙을 저장하지 못했습니다.",
  "guardrails.ruleDeleteFailed": "사용자 지정 규칙을 삭제하지 못했습니다.",
  "guardrails.ruleSaved": "사용자 지정 규칙을 저장했습니다.",
  "guardrails.ruleDeleted": "사용자 지정 규칙을 삭제했습니다.",
  "guardrails.ruleId": "규칙 ID",
  "guardrails.ruleName": "규칙 이름",
  "guardrails.group": "그룹",
  "guardrails.groupPriority": "그룹 우선순위",
  "guardrails.displayName": "표시 이름",
  "guardrails.description": "설명",
  "guardrails.regex": "RE2 패턴",
  "guardrails.placeholderType": "자리표시자 유형",
  "guardrails.captureGroups": "캡처 그룹",
  "guardrails.captureGroupsInvalid": "양의 정수 그룹 번호를 쉼표로 구분해 입력하세요.",
  "guardrails.minLength": "최소 길이",
  "guardrails.entropy": "엔트로피 임계값",
  "guardrails.keywords": "키워드",
  "guardrails.banlist": "금지 목록",
  "guardrails.validators": "검증기",
  "guardrails.saveRule": "규칙 저장",
  "guardrails.cancelEdit": "취소",
  "guardrails.tabsLabel": "Guardrails 섹션",
  "guardrails.tab.overview": "개요",
  "guardrails.tab.rules": "규칙",
  "guardrails.tab.tester": "테스터",
  "guardrails.tab.activity": "활동",
  "guardrails.tab.settings": "설정",
  "guardrails.detectWarning": "감지 전용 모드는 결과를 보고하지만, 민감한 데이터가 프록시를 벗어나기 전에 마스킹하지는 않습니다.",
  "guardrails.passthroughWarning": "Guardrails 처리에 실패했을 때 원본 전달을 허용하면 마스킹되지 않은 입력이 업스트림으로 전송될 수 있습니다.",
  "guardrails.metric.scanned": "스캔한 요청",
  "guardrails.metric.masked": "마스킹한 값",
  "guardrails.metric.detected": "감지한 값",
  "guardrails.metric.errors": "경고 및 차단",
  "guardrails.lastPassthrough": "최근 원본 전달 사고: {date}",
  "guardrails.topRules": "상위 규칙",
  "guardrails.topCategories": "상위 데이터 범주",
  "guardrails.noActivity": "아직 Guardrails 활동이 없습니다",
  "guardrails.noActivityHint": "보호된 요청이 처리되면 여기에 메타데이터가 표시됩니다.",
  "guardrails.documentation": "Guardrails 문서 보기",
  "guardrails.searchRules": "규칙 검색",
  "guardrails.source": "출처",
  "guardrails.sourceOpenCodex": "OpenCodex 규칙",
  "guardrails.sourceManual": "기본 제공",
  "guardrails.allSources": "모든 출처",
  "guardrails.status": "상태",
  "guardrails.allStatuses": "모든 상태",
  "guardrails.allDataTypes": "모든 데이터 유형",
  "guardrails.filteredRules": "필터링된 규칙 {count}개",
  ...
  "guardrails.importReplace": "바꾸기",
  "guardrails.importFailed": "Guardrails 규칙을 가져오지 못했습니다.",
  "guardrails.importTooLarge": "Guardrails 가져오기 파일은 4 MiB 이하여야 합니다.",
  "guardrails.imported": "Guardrails 규칙을 가져왔습니다.",
  "guardrails.noRules": "이 필터와 일치하는 규칙이 없습니다.",
  "guardrails.previous": "이전",
  "guardrails.next": "다음",
  "guardrails.page": "{total}페이지 중 {current}페이지",
  "guardrails.testerTitle": "민감한 데이터 테스터",
  "guardrails.testerHint": "이 OpenCodex 인스턴스의 유효한 레지스트리로 스캔합니다. 샘플은 Management API로 전송되지만 LLM 공급자에게는 전송되지 않으며 서버에 저장되지 않습니다.",
  "guardrails.testerInput": "스캔할 텍스트",
  "guardrails.testerPlaceholder": "여기에 예시 텍스트를 붙여 넣으세요…",
  "guardrails.byteCounter": "{current} / {max}바이트",
  "guardrails.clear": "지우기",
  "guardrails.test": "스캔",
  "guardrails.testing": "스캔 중…",
  "guardrails.testerFailed": "텍스트를 스캔하지 못했습니다.",
  "guardrails.testerResult": "스캔 결과",
  "guardrails.effective": "유효한 설정",
  "guardrails.draft": "초안 설정",
  "guardrails.findings": "감지 결과",
  "guardrails.noFindings": "활성화된 규칙에서 일치 항목을 찾지 못했습니다. 텍스트에 민감한 데이터가 없음을 보장하지는 않습니다.",
  "guardrails.placeholder": "자리표시자",
  "guardrails.offsets": "오프셋",
  "guardrails.activityTitle": "Guardrails 활동",
  "guardrails.activityPrivacy": "메모리 내 메타데이터만 표시되며 감사 로그가 아닙니다. 프롬프트 텍스트와 자리표시자 매핑은 여기에 저장되지 않습니다.",
  "guardrails.surface": "처리 영역",
  "guardrails.allSurfaces": "모든 처리 영역",
  "guardrails.allModes": "모든 모드",
  "guardrails.result": "결과",
  "guardrails.allResults": "모든 결과",
  "guardrails.result.scanned": "스캔됨",
  "guardrails.result.masked": "마스킹됨",
  "guardrails.result.detected": "감지됨",
  "guardrails.result.blocked": "차단됨",
  "guardrails.result.passthrough": "그대로 전달됨",
  "guardrails.result.demaskWarning": "마스킹 해제 경고",
  "guardrails.result.toolSkipped": "도구 복원 건너뜀",
  "guardrails.refresh": "새로 고침",
  "guardrails.retentionEvents": "보관 중인 이벤트: {current} / {max}개",
  "guardrails.retentionEvicted": "제거된 이벤트: {count}개",
  "guardrails.lastRefresh": "마지막 새로 고침: {date}",
  "guardrails.time": "시간",
  "guardrails.count": "개수",
  "guardrails.rules": "규칙",
  "guardrails.latency": "지연 시간",
  "guardrails.dialog.disable.title": "Guardrails를 비활성화하시겠습니까?",
  "guardrails.dialog.disable.changes": "새 요청은 더 이상 스캔되거나 마스킹되지 않습니다.",
  "guardrails.dialog.disable.breakage": "민감한 값이 변경되지 않은 채 이 프록시를 벗어날 수 있습니다.",
  "guardrails.dialog.disable.undo": "개요 또는 설정에서 Guardrails를 다시 활성화할 수 있습니다.",
  "guardrails.dialog.disable.confirm": "비활성화",
  "guardrails.dialog.detect.title": "감지 전용 모드로 전환하시겠습니까?",
  "guardrails.dialog.detect.changes": "감지 결과는 집계되지만 요청 텍스트는 마스킹되지 않습니다.",
  "guardrails.dialog.detect.breakage": "감지 전용 모드는 업스트림으로 전송되는 데이터를 보호하지 않습니다.",
  "guardrails.dialog.detect.undo": "모드를 다시 ‘마스킹 강제’로 전환하세요.",
  "guardrails.dialog.detect.confirm": "감지 전용 모드 사용",
  "guardrails.dialog.passthrough.title": "실패 시 원본 전달을 허용하시겠습니까?",
  "guardrails.dialog.passthrough.changes": "Guardrails 처리에 실패하면 원본 요청이 전달됩니다.",
  "guardrails.dialog.passthrough.breakage": "실패한 요청에 마스킹되지 않은 민감한 값이 포함될 수 있습니다.",
  "guardrails.dialog.passthrough.undo": "실패 처리 방식을 다시 ‘요청 차단’으로 설정하세요.",
  "guardrails.dialog.passthrough.confirm": "원본 전달 허용",
  "guardrails.dialog.delete.title": "사용자 지정 규칙 {ruleId}을(를) 삭제하시겠습니까?",
  "guardrails.dialog.delete.changes": "사용자 지정 규칙이 유효한 레지스트리에서 제거됩니다.",
  "guardrails.dialog.delete.breakage": "이 규칙으로만 감지되는 값은 더 이상 보호되지 않습니다.",
  "guardrails.dialog.delete.undo": "규칙을 가져오거나 다시 만들어 복원할 수 있습니다.",
  "guardrails.dialog.delete.confirm": "규칙 삭제",
  "guardrails.dialog.import.title": "모든 Guardrails 규칙을 바꾸시겠습니까?",
  "guardrails.dialog.import.changes": "가져온 번들이 현재 Guardrails 설정과 사용자 지정 규칙을 바꿉니다.",
  "guardrails.dialog.import.breakage": "번들에 없는 로컬 규칙은 제거됩니다.",
  "guardrails.dialog.import.undo": "바꾸기 전에 현재 번들을 내보내세요.",
  "guardrails.dialog.import.confirm": "규칙 바꾸기",
  "guardrails.sourceGitleaks": "Gitleaks 규칙",
  "guardrails.surfaceCompact": "요약 압축",
  "guardrails.registryReady": "레지스트리 준비됨",
  "guardrails.registryFailed": "레지스트리 실패",
  "guardrails.registryDisabled": "레지스트리 비활성화됨",
  "guardrails.effectiveRules": "유효한 규칙 {count}개",
  "guardrails.registryGeneration": "세대 {generation}",
  "guardrails.testerDraftSettings": "초안 설정 사용",
  "guardrails.testerDraftSettingsHint": "다른 데이터 유형과 키워드 사전 필터 선택을 저장하지 않고 테스트합니다.",
  "guardrails.showingEvents": "일치하는 이벤트 {total}개 중 {shown}개 표시",
  "guardrails.oldestEvent": "보관 중인 가장 오래된 이벤트: {date}",
  "guardrails.tableScrollHint": "모든 열을 보려면 표를 가로로 스크롤하세요.",
  "guardrails.importPreviewTitle": "가져오기 미리 보기",
  "guardrails.importCreateCount": "생성: {count}",
  "guardrails.importReplaceCount": "바꾸기: {count}",
  "guardrails.importUnchangedCount": "변경 없음: {count}",
  "guardrails.importConflicts": "충돌하는 규칙 ID {count}개를 가져오기 전에 해결해야 합니다.",
  "guardrails.importApply": "가져오기 적용",
  "guardrails.category": "범주",
  "guardrails.allCategories": "모든 범주",
  "guardrails.generation": "세대",
  "guardrails.activitySummary": "필터링된 활동 요약",
  "guardrails.activityEvents": "이벤트: {count}",
  "guardrails.activityFindings": "감지 결과: {count}",
  "guardrails.activityAverageLatency": "평균 지연 시간: {value} ms",
  "guardrails.activityTopRule": "상위 규칙: {rule}",
  "guardrails.recentActivity": "최근 활동",
  "guardrails.dialog.ruleDisable.title": "규칙 {ruleId}을(를) 비활성화하시겠습니까?",
  "guardrails.dialog.ruleDisable.changes": "이 기본 제공 규칙은 새 요청 스캔을 중지합니다.",
  "guardrails.dialog.ruleDisable.breakage": "이 규칙으로만 감지되는 값은 더 이상 보호되지 않습니다.",
  "guardrails.dialog.ruleDisable.undo": "규칙 탭에서 이 규칙을 다시 활성화할 수 있습니다.",
  "guardrails.dialog.ruleDisable.confirm": "규칙 비활성화",
  "guardrails.dialog.bulkDisable.title": "규칙 {count}개를 비활성화하시겠습니까?",
  "guardrails.dialog.bulkDisable.changes": "이 선택에 포함된 필터링된 기본 제공 규칙이 모두 비활성화됩니다.",
  "guardrails.dialog.bulkDisable.breakage": "이 규칙들로만 감지되는 민감한 값이 변경되지 않은 채 프록시를 벗어날 수 있습니다.",
  "guardrails.dialog.bulkDisable.undo": "규칙 탭에서 규칙을 다시 활성화하거나 이전에 내보낸 파일을 가져오세요.",
  "guardrails.dialog.bulkDisable.confirm": "규칙 비활성화",
  "guardrails.statusProtected": "보호 중",
  "guardrails.statusDetectOnly": "감지만",
  "guardrails.statusReducedCoverage": "보호 범위 감소",
  "guardrails.statusUnavailable": "레지스트리 사용 불가",
  "guardrails.statusNoRules": "활성 규칙 없음",
  "guardrails.statusNoProviderCoverage": "보호되는 제공자 없음",
  "guardrails.valueOn": "켜짐",
  "guardrails.valueOff": "꺼짐",
  "guardrails.reducedCoverageWarning": "보호 범위가 줄었습니다. 데이터 유형 또는 기본 규칙이 비활성화되었거나 공급자 범위가 제한되었거나 처리 실패가 통과될 수 있습니다.",
  "guardrails.providerScope": "보호할 제공자",
  "guardrails.providerScopeAllValue": "모든 제공자",
  "guardrails.providerScopeSelectedValue": "선택됨({count})",
  "guardrails.importSecurityProviderScope": "제공자 보호 범위: {before} → {after}",
  "guardrails.providerScopeAllHint": "현재 및 향후의 모든 제공자를 보호합니다.",
  "guardrails.providerScopeSelectedHint": "선택한 제공자만 보호합니다. 새 제공자는 선택할 때까지 보호되지 않습니다.",
  "guardrails.providerAnthropicNative": "Anthropic(네이티브)",
  "guardrails.providerDisabled": "비활성화됨",
  "guardrails.providerNotConfigured": "구성되지 않음",
  "guardrails.lastProviderRequired": "제공자를 하나 이상 선택하거나 Guardrails를 전체 비활성화하세요.",
  "guardrails.providerScopeWarning": "제공자 보호 범위가 제한되었습니다. 선택하지 않은 제공자로 가는 요청은 검사되거나 마스킹되지 않습니다.",
  "guardrails.noProviderCoverageWarning": "활성 제공자가 선택되지 않았습니다. 현재 제공자 트래픽은 검사되거나 마스킹되지 않습니다.",
  "guardrails.dialog.providerScope.title": "제공자 보호 범위를 제한할까요?",
  "guardrails.dialog.providerScope.changes": "선택 해제한 제공자로 직접 전송되는 새 요청은 더 이상 검사되거나 마스킹되지 않습니다.",
  "guardrails.dialog.providerScope.breakage": "민감한 값이 변경 없이 해당 제공자에 전달될 수 있습니다. 보호된 연속 요청은 이 경계를 넘지 않습니다.",
  "guardrails.dialog.providerScope.undo": "Guardrails 설정에서 제공자를 다시 선택하면 보호를 복원할 수 있습니다.",
  "guardrails.dialog.providerScope.confirm": "범위 제한",
  "guardrails.lastDataTypeRequired": "데이터 유형을 하나 이상 활성화해야 합니다.",
  "guardrails.importSecurityTitle": "보안 설정",
  "guardrails.importSecurityWeakening": "이 가져오기는 보호를 약화합니다. 계속하기 전에 강조된 변경 사항을 모두 검토하세요.",
  "guardrails.importSecurityPotential": "이 가져오기는 보안 관련 사용자 규칙 정의를 변경하며 보호를 약화할 수 있습니다. 계속하기 전에 검토하세요.",
  "guardrails.importSecurityUnchanged": "Guardrails 보안 설정은 변경되지 않습니다.",
  "guardrails.importSecurityEnabled": "트래픽 보호: {before} → {after}",
  "guardrails.importSecurityMode": "모드: {before} → {after}",
  "guardrails.importSecurityFailure": "실패 처리: {before} → {after}",
  "guardrails.importSecurityDataTypes": "활성 데이터 유형: {before} → {after}",
  "guardrails.importSecurityDisabledRules": "비활성 기본 제공 규칙: {before} → {after} (새로 비활성: {disabled}, 다시 활성: {reenabled})",
  "guardrails.importSecurityCustomRules": "사용자 규칙: {before} → {after} (삭제: {removed}, 변경: {changed})",
  "guardrails.importSecurityChangedRuleIds": "정의가 변경된 규칙:",
  "guardrails.importSecurityRemovedRuleIds": "삭제된 규칙 ID:",
  "guardrails.importSecurityPrefilter": "키워드 사전 필터: {before} → {after}",
  "guardrails.importSecurityReduced": "보호 감소",
  "guardrails.importSecurityReviewRequired": "보안 검토 필요",
  "guardrails.importSecurityRemovedTypes": "더 이상 보호하지 않음: {types}",
  "guardrails.testerSimulation": "Tester 시뮬레이션 전용입니다. 합성 값을 사용하고 실제 비밀을 붙여 넣지 마세요. 연결 모드에서는 샘플이 OpenCodex 허브를 통과할 수 있습니다.",
  "guardrails.testerTrafficDisabled": "실제 트래픽 보호가 꺼져 있습니다. 현재 요청은 Guardrails 마스킹 없이 프록시를 벗어납니다.",
  "guardrails.testerTrafficDetect": "실제 트래픽은 감지만 수행하며 공급자에 도달하기 전에 마스킹되지 않습니다.",
  "guardrails.testerTrafficUnknown": "실제 트래픽 보호 상태를 아직 알 수 없습니다. Guardrails 상태가 로드될 때까지 기다리세요.",
  "guardrails.testerTrafficUnavailable": "실제 트래픽 보호를 사용할 수 없습니다. Guardrails 활성화 또는 레지스트리 오류를 해결하세요.",
  "guardrails.testerTrafficNoRules": "실제 트래픽에 활성 Guardrails 규칙이 없습니다. 하나 이상의 유효한 규칙을 활성화하세요.",
  "guardrails.testerTrafficNoProviderCoverage": "시뮬레이션은 일치 항목을 찾을 수 있지만 트래픽 보호 대상으로 선택된 활성 제공자가 없습니다.",
  "guardrails.testerTrafficReduced": "실제 트래픽 보호 범위가 축소되었습니다. 비활성화된 규칙, 데이터 유형, 공급자 범위 및 실패 정책을 확인하세요.",
  "guardrails.dialog.categoryDisable.title": "데이터 범주를 비활성화하시겠습니까?",
  "guardrails.dialog.categoryDisable.changes": "이 범주의 규칙은 새 요청을 더 이상 검사하지 않습니다.",
  "guardrails.dialog.categoryDisable.breakage": "이 범주만 감지하는 민감한 값은 변경되지 않은 채 프록시를 벗어날 수 있습니다.",
  "guardrails.dialog.categoryDisable.undo": "Guardrails 설정에서 범주를 다시 활성화하세요.",
  "guardrails.dialog.categoryDisable.confirm": "범주 비활성화",
  "guardrails.dialog.prefilter.title": "키워드 사전 필터를 활성화하시겠습니까?",
  "guardrails.dialog.prefilter.changes": "후보 텍스트에 키워드가 없으면 키워드가 있는 규칙을 건너뛸 수 있습니다.",
  "guardrails.dialog.prefilter.breakage": "이 성능 절충은 감지 범위를 줄일 수 있습니다.",
  "guardrails.dialog.prefilter.undo": "Guardrails 설정에서 키워드 사전 필터를 끄세요.",
  "guardrails.dialog.prefilter.confirm": "사전 필터 활성화",
  "guardrails.dialog.importWeakening.title": "보호를 약화하는 가져오기를 적용하시겠습니까?",
  "guardrails.dialog.importWeakening.changes": "가져온 번들은 Guardrails 설정과 사용자 지정 규칙을 미리 본 값으로 바꿉니다.",
  "guardrails.dialog.importWeakening.breakage": "강조된 설정으로 인해 더 많은 민감한 값이 변경되지 않은 채 공급자에 도달할 수 있습니다.",
  "guardrails.dialog.importWeakening.undo": "이 가져오기를 적용하기 전에 현재 번들을 내보내세요.",
  "guardrails.dialog.importWeakening.confirm": "감소된 보호 적용",};
