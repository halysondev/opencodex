...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.cursor.installerOpen": "설치 프로그램 페이지 열기",
  "integrations.cursor.installerUnavailable": "지금은 Cursor 업데이트 채널에서 Private Inference 설치 프로그램을 확인할 수 없습니다. Cursor가 안내하는 대로 수동으로 설치할 수 있으며, 아래 게이트웨이 값은 어느 쪽이든 유효합니다.",
