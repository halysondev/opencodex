...
export const ko: Record<TKey, string> = {
  ...
  "zcodeDesktop.intro": "이 컴퓨터의 ZCode Desktop에 설정된 Z.AI 모델을 연결합니다. API 키를 붙여 넣을 필요가 없습니다. 공식 런타임을 시작하며 기존 Desktop 대화에는 연결하지 않습니다.",
  "zcodeDesktop.connected": "Desktop 연결됨 · 로컬 프로토콜 확인됨",
  ...
  "zcodeDesktop.consent": "ZCode가 이 폴더에서 파일을 수정하고 명령을 실행하도록 허용합니다. Desktop 설정은 읽기 전용입니다. 명령은 네트워크에 접근할 수 있습니다. 신뢰할 수 있는 공식 설치만 연결하세요.",
  "zcodeDesktop.back": "뒤로",
  "zcodeDesktop.connect": "Desktop 연결",
  "zcodeDesktop.disconnect": "연결 해제",
  "zcodeDesktop.use": "이 제공자 사용",
