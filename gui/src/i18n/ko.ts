...
"skills.title": "스킬 제어 플레인",
  "skills.subtitle": "범용 에이전트 스킬 레지스트리, 시각 마켓플레이스, 정책 기반 배포.",
  "skills.refresh": "새로고침",
  "skills.refreshing": "새로고침 중…",
  "skills.tab.overview": "개요",
  "skills.tab.marketplace": "마켓플레이스",
  "skills.tab.registry": "레지스트리 ({count})",
  "skills.tab.editor": "스킬 편집기",
  "skills.tab.matrix": "배포 매트릭스",
  "skills.tab.agents": "에이전트",
  "skills.tab.nodes": "원격 노드",
  "skills.tab.drift": "드리프트 및 롤백",
  "skills.tab.reviews": "검토 대기열",
  "skills.tab.audit": "감사 기록",
  "skills.card.registered": "등록된 스킬",
  "skills.card.deployments": "활성 배포",
  "skills.card.marketplace": "마켓플레이스 항목",
  "skills.card.audit": "감사 이벤트",
  "skills.recentActivity": "최근 제어 플레인 활동",
  "skills.noEvents": "최근 이벤트가 없습니다.",
  "skills.col.timestamp": "시각",
  "skills.col.event": "이벤트",
  "skills.col.actor": "행위자",
  "skills.col.target": "대상",
  "skills.searchPlaceholder": "공개 skills.sh 카탈로그 검색…",
  "skills.byAuthor": "v{version} · {author}",
  "skills.verified": "검증됨",
  "skills.importToRegistry": "레지스트리로 가져오기",
  "skills.emptyRegistry": "등록된 스킬이 없습니다. 마켓플레이스 또는 로컬 폴더에서 가져오세요.",
  "skills.col.skill": "스킬",
  "skills.col.version": "버전",
  "skills.col.status": "상태",
  "skills.col.risk": "위험",
  "skills.col.tags": "태그",
  "skills.col.actions": "작업",
  "skills.publish": "게시",
  "skills.deployCodex": "Codex에 배포",
  "skills.editorTitle": "SKILL.md 편집기",
  "skills.editorNamePlaceholder": "스킬 이름",
  "skills.editorVersionPlaceholder": "버전",
  "skills.editorDefaultName": "사용자 지정 어시스턴트",
  "skills.editorDefaultMarkdown": "---\nname: custom-assistant\ndisplayName: Custom Assistant\nversion: 1.0.0\ndescription: Custom guidance procedure.\ntags: custom, utility\n---\n\n# Custom Assistant\n\nInstructions for the agent.\n",
  "skills.saveDraft": "초안 저장",
  "skills.previewTitle": "실시간 미리보기",
  "skills.matrixTitle": "플릿 배포 매트릭스",
  ...
  "skills.notInstalled": "설치되지 않음",
  "skills.inSync": "v{version} 동기화됨",
  "skills.blocked": "차단됨",
  "skills.agentsTitle": "대상 에이전트 플릿",
  "skills.col.agent": "에이전트",
  "skills.col.userRoot": "대상 루트(사용자 범위)",
  "skills.col.projectRoot": "대상 루트(프로젝트 범위)",
  "skills.col.adapterVersion": "어댑터 버전",
  "skills.agent.openaiCodex": "OpenAI Codex",
  "skills.agent.universalAgent": "범용 에이전트",
  "skills.statusReady": "준비됨",
  "skills.nodesTitle": "원격 실행 노드(SSH)",
  "skills.nodesHelp": "호스트 키 핀을 엄격히 적용하여 원격 VPS, GPU 워커, 개발 호스트를 관리합니다.",
  "skills.col.node": "노드",
  "skills.col.type": "유형",
  "skills.col.host": "호스트",
  "skills.col.environment": "환경",
  "skills.localMachine": "로컬 머신",
  "skills.self": "자신",
  "skills.vpsMain": "VPS Main",
  "skills.testConnection": "연결 테스트",
  "skills.driftTitle": "구성 드리프트 및 롤백",
  "skills.driftHelp": "지속 모니터링은 라이브 디스크 파일을 불변 레지스트리 콘텐츠 해시와 비교합니다.",
  "skills.col.deployment": "배포",
  "skills.col.targetPath": "대상 경로",
  "skills.col.driftState": "드리프트 상태",
  "skills.checkHash": "해시 확인",
  "skills.reviewsTitle": "정책 및 승인 대기열",
  "skills.reviewsEmpty": "운영자 결정이 필요한 보류 중인 승격 검토가 없습니다.",
  "skills.auditTitle": "감사 로그",
  "skills.col.eventType": "이벤트 유형",
  "skills.col.targetId": "대상 ID",
  "skills.system": "system",
  "skills.status.importing": "{id} 가져오는 중…",
  "skills.status.imported": "{id}을(를) 가져왔습니다.",
  "skills.status.importFailed": "가져오기 실패: {error}",
  "skills.status.publishing": "{id} 게시 중…",
  "skills.status.published": "{id}을(를) 게시했습니다.",
  "skills.status.publishFailed": "게시 실패: {error}",
  "skills.status.planning": "{id}을(를) {agent}에 배포할 계획 중…",
  "skills.status.deployed": "{id}을(를) {agent}에 배포했습니다.",
  "skills.status.deployFailed": "배포 실패: {error}",
  "skills.status.saved": "스킬 초안을 레지스트리에 저장했습니다.",
  "skills.status.saveFailed": "저장 실패: {error}",
  "skills.loadFailed": "스킬 제어 플레인 데이터를 불러오지 못했습니다.",
  "security.title": "보안 제어 플레인",
  "security.subtitle": "인가 우선 정찰 및 검증. 대상 작업은 기본적으로 거부됩니다. R3는 차단됩니다. 해시로 이동 가능하며 사이드바 NAV 행이 아닙니다.",
  "security.refresh": "새로고침",
  "security.refreshing": "새로고침 중…",
  "security.banner": "인가된 대상만. 알 수 없는 자산, 만료된 인가, 제외된 호스트는 거부됩니다. 라이브 타사 도구는 호출하지 않으며 정찰은 로컬 픽스처를 사용합니다.",
  "security.flagOff": "기능 플래그 PAO_SECURITY_CONTROL_PLANE이 꺼져 있어 변경이 거부됩니다.",
  "security.status.posting": "POST {path}",
  "security.status.ok": "OK {path}",
  "security.status.failed": "실패: {error}",
  "security.evidence.campaign": "캠페인 증거: {campaign}",
  "security.evidence.none": "활성 캠페인 없음",
  "security.tab.overview": "개요",
  "security.tab.authorizations": "인가",
  "security.tab.scopes": "범위",
  "security.tab.campaigns": "캠페인",
  "security.tab.approvals": "승인",
  "security.tab.findings": "발견",
  "security.tab.evidence": "증거",
  "security.tab.skills": "패키지",
  "security.tab.tools": "도구",
  "security.tab.mcp": "MCP",
  "security.tab.policies": "정책",
  "security.tab.audit": "감사",
  "security.card.enabled": "사용",
  "security.card.campaigns": "캠페인",
  "security.card.approvals": "승인",
  "security.card.leads": "리드",
  "security.card.validated": "검증됨",
  "security.card.blocked": "차단됨",
  "security.card.authExpiring": "인가 만료 임박",
  "security.card.breakers": "회로 차단기",
  "security.yes": "예",
  "security.no": "아니요",
  "security.col.id": "ID",
  "security.col.type": "유형",
  "security.col.status": "상태",
  "security.col.validUntil": "유효 기간",
  "security.col.name": "이름",
  "security.col.actions": "작업",
  "security.col.target": "대상",
  "security.col.title": "제목",
  "security.col.severity": "심각도",
  "security.col.sha256": "SHA-256",
  "security.col.preview": "미리보기",
  "security.col.compatibility": "호환성",
  "security.col.kind": "종류",
  "security.col.allowlisted": "허용 목록",
  "security.col.health": "상태",
  "security.col.credential": "자격 증명",
  "security.col.ceiling": "상한",
  "security.col.blockR3": "R3 차단",
  "security.col.when": "시각",
  "security.col.event": "이벤트",
  "security.col.actor": "행위자",
  "security.start": "시작",
  "security.pause": "일시 중지",
  "security.reconLab": "Recon lab.local",
  "security.approveOnce": "한 번만 승인",
  "security.deny": "거부",
  "security.reasonBounded": "한 번으로 제한",
  "security.reasonDenied": "거부됨",
  "security.hashes": "북마크 가능한 해시: {hashes}",
  "security.loadFailed": "보안 제어 플레인 데이터를 불러오지 못했습니다.",
  "credentials.title": "프로바이더 액세스 제어 플레인",
  "credentials.subtitle": "암호화된 자격 증명, 상태 점검 토큰 풀, OAuth 게이트웨이, 정책 기반 리스. 해시로 이동 가능하며 사이드바 NAV 행이 아닙니다.",
  "credentials.refresh": "새로 고침",
  "credentials.refreshing": "새로 고치는 중…",
  "credentials.banner": "비밀은 평문으로 목록에 표시되지 않습니다. 이 단계의 상태 점검은 픽스처/인프로세스입니다. 이 플레인은 프로바이더 계정을 등록하지 않습니다.",
  "credentials.flagOff": "기능 플래그 CREDENTIAL_RUNTIME_ENABLED가 꺼져 있어 변경이 거부됩니다.",
  "credentials.status.posting": "POST {path}",
  "credentials.status.ok": "OK {path}",
  "credentials.status.failed": "실패: {error}",
  "credentials.tab.overview": "개요",
  "credentials.tab.list": "자격 증명",
  "credentials.tab.providers": "프로바이더",
  "credentials.tab.oauth": "OAuth",
  "credentials.tab.pool": "풀",
  "credentials.tab.health": "상태",
  "credentials.tab.quota": "할당량",
  "credentials.tab.policies": "정책",
  "credentials.tab.approvals": "승인",
  "credentials.tab.audit": "감사",
  "credentials.card.enabled": "사용",
  "credentials.card.total": "전체",
  "credentials.card.healthy": "정상",
  "credentials.card.degraded": "저하",
  "credentials.card.quarantined": "격리",
  "credentials.card.revoked": "취소됨",
  "credentials.card.leases": "리스",
  "credentials.card.breakers": "차단기",
  "credentials.card.vault": "볼트",
  "credentials.yes": "예",
  "credentials.no": "아니요",
  "credentials.available": "사용 가능",
  "credentials.unavailable": "사용 불가",
  "credentials.col.id": "ID",
  "credentials.col.name": "이름",
  "credentials.col.provider": "프로바이더",
  "credentials.col.status": "상태",
  "credentials.col.health": "상태",
  "credentials.col.secret": "비밀",
  "credentials.col.eligible": "적격",
  "credentials.col.actions": "작업",
  "credentials.col.score": "점수",
  "credentials.col.adapter": "어댑터",
  "credentials.col.oauth": "OAuth",
  "credentials.col.enabled": "사용",
  "credentials.col.session": "세션",
  "credentials.col.redirect": "리디렉션",
  "credentials.col.budget": "예산",
  "credentials.col.priority": "우선순위",
  "credentials.col.action": "작업",
  "credentials.col.target": "대상",
  "credentials.col.when": "시각",
  "credentials.col.event": "이벤트",
  "credentials.col.actor": "행위자",
  "credentials.col.decision": "결정",
  "credentials.validate": "검증",
  "credentials.quarantine": "격리",
  "credentials.revoke": "취소",
  "credentials.healthRun": "상태 점검 실행",
  "credentials.approve": "승인",
  "credentials.reject": "거부",
  "credentials.hashes": "북마크 가능한 해시: {hashes}",
  "credentials.loadFailed": "자격 증명 런타임 데이터를 불러오지 못했습니다.",
  "social.title": "소셜 발행 제어 플레인",
  "social.subtitle": "에이전트 소셜 발행 오케스트레이션, 다중 플랫폼 렌디션 및 OpenPost 스케줄링.",
    "social.tablist": "소셜 게시 탭",
"social.refresh": "새로고침",
  "social.refreshing": "새로고침 중…",
  "social.banner": "OpenPost 연결됨. OAuth 비밀은 OpenPost 내에 보호됩니다. 발행 전 사람의 승인이 필요합니다.",
  "social.flagOff": "기능 플래그 SOCIAL_PUBLISHING_ENABLED 꺼짐 — 변경이 거부됩니다.",
  "social.tab.overview": "개요",
  "social.tab.accounts": "계정",
  "social.tab.publications": "발행물",
  "social.tab.approvals": "승인",
  "social.tab.jobs": "전달 작업",
  "social.tab.analytics": "분석",
  "social.tab.instances": "OpenPost 인스턴스",
  "social.tab.audit": "감사 기록",
  "social.card.enabled": "활성화됨",
  "social.card.instances": "인스턴스",
  "social.card.accounts": "계정 수",
  "social.card.readyAccounts": "준비된 계정",
  "social.card.publications": "발행물 수",
  "social.card.scheduled": "예약됨",
  "social.card.pendingApprovals": "승인 대기",
  "social.card.failedDeliveries": "실패한 전달",
  "social.yes": "예",
  "social.no": "아니요",
  "social.col.id": "ID",
  "social.col.platform": "플랫폼",
  "social.col.displayName": "표시 이름",
  "social.col.readiness": "준비 상태",
  "social.col.enabled": "활성",
  "social.col.actions": "작업",
  "social.col.sourceType": "소스 유형",
  "social.col.title": "제목",
  "social.col.status": "상태",
  "social.col.scheduledAt": "예약 시간",
  "social.col.name": "이름",
  "social.col.baseUrl": "기본 URL",
  "social.col.version": "버전",
  "social.col.pubId": "발행물",
  "social.col.jobType": "작업 유형",
  "social.col.attempts": "시도",
  "social.col.error": "오류",
  "social.col.when": "시간",
  "social.col.actor": "주체",
  "social.col.action": "동작",
  "social.col.resource": "리소스",
  "social.col.resourceId": "리소스 ID",
  "social.col.decision": "결정",
  "social.col.approver": "승인자",
  "social.col.approvalScope": "승인 범위",
  "social.col.contentHash": "콘텐츠 해시",
  "social.col.account": "계정",
  "social.col.capturedAt": "캡처 시각",
  "social.col.views": "조회수",
  "social.col.impressions": "노출수",
  "social.col.engagements": "참여 수",
  "social.col.followersDelta": "팔로워 변동",
  "social.emptyAccounts": "연결된 계정이 없습니다. OpenPost에서 동기화하세요.",
  "social.emptyPublications": "발행물이 없습니다.",
  "social.emptyInstances": "등록된 OpenPost 인스턴스가 없습니다.",
  "social.emptyJobs": "전달 작업이 없습니다.",
  "social.emptyAudit": "감사 이벤트가 없습니다.",
  "social.emptyApprovals": "승인 기록이 아직 없습니다.",
  "social.emptyAnalytics": "분석 스냅샷이 아직 없습니다.",
  "social.refreshCaps": "기능 갱신",
  "social.validate": "검증",
  "social.approve": "승인",
  "social.publish": "즉시 발행",
  "social.test": "연결 테스트",
  "social.syncAccounts": "계정 동기화",
  "social.status.posting": "POST {path}",
  "social.status.ok": "OK {path}",
  "social.status.failed": "실패: {error}",
  "social.hashes": "북마크 해시: {hashes}",
};
