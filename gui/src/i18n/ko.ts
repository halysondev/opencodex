...
export const ko: Record<TKey, string> = {
  ...
  "zcodeDesktop.testHint": "선택 사항: ZCode를 통해 짧은 요청을 한 번 보내 모델 접근을 확인합니다. 계정 할당량을 사용합니다. 연결만으로는 사용하지 않습니다.",
  ...
  "zcodeDesktop.inferenceFailed": "ZCode 테스트가 완료되지 않았습니다. Desktop 로그인과 모델 권한을 확인하고 다시 연결하세요. 직접 API로 대체하지 않았습니다.",
