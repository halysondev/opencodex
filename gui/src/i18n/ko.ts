...
export const ko: Record<TKey, string> = {
  ...
  "zcodeUsage.offPeak": "오프피크: {until}까지 표준 모델 크레딧 요금 50% 할인.",
  "zcodeUsage.flashActive": "ZCode 경유 GLM-5.3-Flash 무료 시간 활성: 아래 조건 충족 시 {end}까지 할당량 차감 없음.",
  "zcodeUsage.flashNext": "다음 ZCode 경유 GLM-5.3-Flash 무료 시간: {start} – {end}.",
  "zcodeUsage.eligibility": "유료 GLM Coding Plan, ZCode 3.10 이상, 5시간 및 주간 한도 모두에 잔여 할당량이 필요합니다. 잔액과 자격은 여기서 확인하지 않습니다. GLM-5.3 및 다른 에이전트에는 이 무차감 혜택이 적용되지 않습니다.",
  "zcodeUsage.rules": "피크: 싱가포르 월–금 14–18시, 나머지는 오프피크. Flash 행사: 2026년 9월 3–20일, 매일 싱가포르 23–다음 날 9시. 마지막 밤 연장이 명시되지 않아 9월 20일 종료 시 안내를 보수적으로 중단합니다. 사용량 및 비용 보고서는 변경하지 않습니다.",
  "zcodeUsage.source": "공식 요금 · 2026년 9월 11일 확인",
  "zcodeUsage.campaignSource": "공식 행사 조건",
  "zcodeDesktop.providerPending": "Desktop 프로토콜은 확인했지만 공급자 등록이 미완료입니다. 활성화를 재시도하세요. 기존 설정은 유지됩니다.",
  ...
  "zcodeAccounts.consent": "공식 ZCode 로그인과 계정 관리를 허용합니다. 로그인 완료 시 기본값 변경이나 추론 없이 공급자와 카탈로그를 활성화합니다.",
  "zcodeAccounts.add": "계정 추가",
  "zcodeAccounts.loginHint": "브라우저에서 공식 로그인을 완료하세요. 다른 계정은 계정을 전환하거나 비공개 창을 사용하세요. 링크는 만료됩니다. 이 패널을 열어 두세요.",
  "zcodeAccounts.login": "공식 로그인 열기",
  "zcodeAccounts.failed": "작업을 완료할 수 없습니다. 만료 시 재로그인하고 중복 계정은 재연결하세요. 실행 중인 작업을 기다리고 삭제 전 라우팅 참조를 제거하세요.",
  "zcodeAccounts.pending": "계정 설정 미완료",
  "zcodeAccounts.reconnect": "다시 로그인",
  ...
  "zcodeDesktop.open": "ZCode Desktop 열기",
  "zcodeDesktop.detect": "다시 감지",
  "zcodeDesktop.download": "ZCode 다운로드",
  "zcodeDesktop.location": "Desktop 설치 폴더(고급)",
  "zcodeDesktop.workspace": "작업 폴더",
  "zcodeDesktop.browse": "폴더 찾아보기",
  "zcodeDesktop.up": "상위 폴더",
  "zcodeDesktop.select": "선택",
  "zcodeDesktop.consent": "이 작업 공간에서 공식 ZCode 실행, Desktop 프로필 읽기, 공급자 활성화 및 Codex 카탈로그 업데이트를 허용합니다. 나중에 요청을 보내면 ZCode가 네이티브 도구를 실행할 수 있습니다.",
  "zcodeDesktop.back": "뒤로",
  "zcodeDesktop.connect": "Desktop 연결",
  "zcodeDesktop.disconnect": "연결 해제",
  "zcodeDesktop.testHint": "선택 사항: 모델 턴이나 네이티브 도구를 시작하거나 할당량을 사용하지 않고 공식 ZCode 프로토콜과 선택한 모델을 다시 확인합니다.",
  "zcodeDesktop.model": "모델",
  "zcodeDesktop.test": "프로토콜 다시 확인",
  "zcodeDesktop.testPassed": "ZCode 프로토콜 확인에 성공했습니다.",
  ...
  "zcodeDesktop.protocolFailed": "ZCode 프로토콜 확인이 완료되지 않았습니다. Desktop 로그인과 모델 권한을 확인하고 다시 연결하세요. 모델 턴, 네이티브 도구 또는 직접 API 대체는 사용되지 않았습니다.",
  "zcodeDesktop.failed": "공식 런타임에 연결할 수 없습니다. Desktop, 폴더 및 격리 요구 사항을 확인하세요.",
