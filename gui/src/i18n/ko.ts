...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.copilotContextTier": "GitHub Copilot 컨텍스트 티어",
  "pws.copilotContextTierDefault": "기본 컨텍스트",
  "pws.copilotContextTierLong": "긴 컨텍스트 (지원되는 경우)",
  "pws.copilotContextTierDesc": "감지되었거나 구성된 각 Copilot 모델의 컨텍스트 티어를 선택합니다. OpenCodex는 지원되는 경우 선택한 티어를 전달하며 프로바이더 cap은 계속 카탈로그 창을 제한합니다.",
  "pws.copilotContextTierNoModels": "아직 감지된 Copilot 모델이 없습니다. 모델을 새로 고치거나 모델 탭에서 하나를 구성하세요.",
