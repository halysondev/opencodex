...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "guardrails.testerHint": "유효한 레지스트리를 사용해 로컬에서 스캔합니다. 텍스트는 업스트림으로 전송되거나 보관되지 않습니다.",
  ...
  "guardrails.testerSimulation": "로컬 시뮬레이션 전용입니다. 합성 테스트 값을 사용하고 실제 비밀을 붙여 넣지 마세요. 텍스트는 공급자에게 전송되거나 저장되지 않습니다.",
