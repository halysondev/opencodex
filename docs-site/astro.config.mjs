      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Strict Codex Pool Quota", translations: { ko: "Strict Codex Pool Quota", fr: "Strict Codex Pool Quota", "zh-CN": "严格 Codex 账户池额度门禁", "zh-TW": "嚴格 Codex 帳戶池額度門禁", ru: "Strict Codex Pool Quota", ja: "Strict Codex Pool Quota", tr: "Strict Codex Pool Quota" }, slug: "guides/codex-strict-quota" },
