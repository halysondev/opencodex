      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Guardrails", translations: { fr: "Protection des données", ko: "데이터 보호", "zh-CN": "数据防护", "zh-TW": "資料防護", ru: "Защита данных", ja: "データ保護", tr: "Veri Koruması" }, slug: "guides/guardrails" },
