...
export const SERIAL_FULL_SUITE_FILES = [
  ...
  // Cold RE2 registry compilation in isolated files competes with unrelated I/O deadlines.
  // Keep the Guardrails domain and its cross-domain engine integrations in one-worker lanes.
  "guardrails/guardrails-activation.test.ts",
  "guardrails/guardrails-algorithm-regression.test.ts",
  "guardrails/guardrails-anthropic-native.test.ts",
  "guardrails/guardrails-assets.test.ts",
  "guardrails/guardrails-chat-native.test.ts",
  "guardrails/guardrails-compact.test.ts",
  "guardrails/guardrails-config.test.ts",
  "guardrails/guardrails-continuations.test.ts",
  "guardrails/guardrails-data-plane.test.ts",
  "guardrails/guardrails-donor-parity.test.ts",
  "guardrails/guardrails-fields.test.ts",
  "guardrails/guardrails-loop-messages.test.ts",
  "guardrails/guardrails-management-api.test.ts",
  "guardrails/guardrails-placeholders.test.ts",
  "guardrails/guardrails-privacy-telemetry.test.ts",
  "guardrails/guardrails-refresh-248.test.ts",
  "guardrails/guardrails-registry.test.ts",
  "guardrails/guardrails-runtime.test.ts",
