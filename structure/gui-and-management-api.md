...
catalog; a ready activation treats the secondary local account-list refresh as best effort
independently of any parent callback, and a partial result stays visible and retryable. No default selection or inference is
